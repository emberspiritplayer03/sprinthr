...
<div id="profile_tab">
    <a class="blue_button btn-help" title="Help" href="<?php echo $hdr_help_url; ?>"><i class="icon-white icon-question-sign"></i></a>
    <?php if($emp_request_approval > 0) { ?>
    	<div class="pt_notification">
            <a href="<?php echo url('dashboard/for_approval');?>" id="" class="" onclick=""> <i></i>Approvals <span id="noti_count" class="noti_count"><?php echo $emp_request_approval;?> </span> </a>
        </div>  
    <?php } ?>
    <ul>
