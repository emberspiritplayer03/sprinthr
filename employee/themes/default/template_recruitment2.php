...
<div id="content" class="fullwidth">
	<div class="mtcntnr">
        ...
        <?php if($can_manage) { ?>
        <a class="add_button" id="add_candidate_button_wrapper" href="#candidate_form_wrapper" onClick="javascript:load_add_candidate();"><strong>+</strong><b>Add Candidate</b></a>
        <?php } ?>
