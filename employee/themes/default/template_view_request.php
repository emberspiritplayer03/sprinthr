<?php include('includes/header_no_menu.php');?>
<div id="content" class="fullwidth">
	<div class="mtcntnr"><h1 class="module_title"><i class="mticon_img"></i><?php echo $page_title . $module_title;?></h1><div class="mtshad"></div></div>
	<div id="main">
