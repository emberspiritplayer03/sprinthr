<script>
	$(function() {	
		jq17('.dropdown-toggle_multi').dropdown();		
		  var oTable = $('#overtime_approved_dt').dataTable({   
		   "aoColumns": [
			...
			'sAjaxSource': base_url + 'overtime/_load_overtime_approved_dt',
...
<table id="overtime_approved_dt" class="formtable">
    <thead>
      <tr>
      	<th valign="top" ></th>       
