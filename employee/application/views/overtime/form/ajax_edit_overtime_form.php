<form onsubmit="return checkForm()" method="post" id="edit_request_form" action="<?php echo $action;?>">
...
<script type="text/javascript">	
	...
	$('#edit_request_form #schedule_time_in').timepicker({
		'minTime': '8:00 am',
		'maxTime': '7:30 am',
		'timeFormat': 'g:i a'
	});
	$('#edit_request_form #schedule_time_out').timepicker({
		'minTime': '8:00 am',
		'maxTime': '7:30 am',
		'timeFormat': 'g:i a'
	});	
	...
	function checkForm() {
		var time_in = $('#edit_request_form #schedule_time_in').val();
		var time_out = $('#edit_request_form #schedule_time_out').val();
		var date = $('#edit_request_form #schedule_date').val();
