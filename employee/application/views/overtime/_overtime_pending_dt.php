<script>
	$(function() {		
		jq17('.dropdown-toggle_multi').dropdown();	  
		  var oTable = $('#overtime_pending_dt').dataTable({   
		   "aoColumns": [
			...
			'sAjaxSource': base_url + 'overtime/_load_overtime_pending_dt',
			"fnDrawCallback": function() {
					...
					$(".btn-edit-overtime").click(function(){
						var request_id = $(this).attr("id");
						editOvertime(request_id);
					});
...
<h2>For Approval Overtime</h2>
<table id="overtime_pending_dt" class="formtable">
    <thead>
      <tr>
      	<th valign="top" ></th>       
