...
<table>
	...
	<tr>
		<td class="field_label">Date Requested </td>
		<td>
			: <input class="input-large" type="text" readonly="readonly" value="<?php echo $date_requested; ?>" style="width:292px;" />
		</td>
	</tr>  
	<tr>
...
<div id="form_default" class="form_action_section">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
    	<tr>
            ...
            <td>
            <input type="submit" name="status" value="Approve" class="curve blue_button" />         
            <input type="submit" name="status" value="Disapprove" class="curve blue_button" />                
            </td>
        </tr>
    </table>
</div>
