<script>
	$(function() {	
		jq17('.dropdown-toggle_multi').dropdown();	
		  var oTable = $('#ob_disapproved_dt').dataTable({   
		   "aoColumns": [
			...
			'sAjaxSource': base_url + 'ob/_load_ob_disapproved_dt',
			"fnDrawCallback": function() {
					jq17('.dropdown-toggle').dropdown();

					$(".btn-view-approver").click(function(){
						var request_id = $(this).attr("id");
						viewObApprovers(request_id);
					});
...
<h2>Disapproved Official Business</h2>
<table id="ob_disapproved_dt" class="formtable">
    <thead>
      <tr>
      	<th valign="top" ></th>       
