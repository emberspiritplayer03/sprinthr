<script>
	$(function() {		
		jq17('.dropdown-toggle_multi').dropdown();	
		  var oTable = $('#ob_pending_dt').dataTable({   
		   "aoColumns": [
			...
			'sAjaxSource': base_url + 'ob/_load_ob_pending_dt',
...
<h2>For Approval Official Business</h2>
<table id="ob_pending_dt" class="formtable">
    <thead>
      <tr>
      	<th valign="top" ></th>       
