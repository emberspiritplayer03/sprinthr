<script>
	$(function() {		
		jq17('.dropdown-toggle_multi').dropdown();	
		  var oTable = $('#leave_disapproved_dt').dataTable({   
		   "aoColumns": [
			...
			'sAjaxSource': base_url + 'leave/_load_leave_disapproved_dt',
...
<h2>Disapproved Leave</h2>
<table id="leave_disapproved_dt" class="formtable">
    <thead>
      <tr>
      	<th valign="top" ></th>       
