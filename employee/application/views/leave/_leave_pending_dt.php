<script>
	$(function() {		
		jq17('.dropdown-toggle_multi').dropdown();	
		  var oTable = $('#leave_pending_dt').dataTable({   
		   "aoColumns": [
			...
			'sAjaxSource': base_url + 'leave/_load_leave_pending_dt',
...
<h2>For Approval Leave</h2>
<table id="leave_pending_dt" class="formtable">
    <thead>
      <tr>
      	<th valign="top" ></th>       
