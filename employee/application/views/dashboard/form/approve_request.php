...
<form id="approve_request_form" method="post" action="<?php echo url('dashboard/_approve_request'); ?>">
		    	...
		    	<tbody> 
		    		<tr>
		    			<td class="field_label" colspan="2">
		    				<div class="alert alert-info"><i class="icon icon-exclamation-sign"></i> Are you sure you want to <b>Approve</b></div>
		    			</td>
		    		</tr>
			        <tr>
