...
<div id="content" class="sidebar_left">
	<div class="mtcntnr">
    	<h1 class="module_title"><i class="mticon_img icon_employee"></i><?php echo $page_title;?><?php echo $page_subtitle;?><a class="add_button" id="add_employee_button_wrapper" href="javascript:void(0)" onclick="javascript:addHoliday()"><strong>+</strong><b>Add Holiday</b></a><a class="gray_button title_back_button" href="javascript:history.go(-1)"><i></i>Back</a></h1><div class="mtshad"></div>
    </div>
