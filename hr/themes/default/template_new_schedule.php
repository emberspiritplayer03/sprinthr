...
<div id="content" class="sidebar_left">
    <div class="mtcntnr">
        <h1 class="module_title"><i class="mticon_img icon_reports"></i><?php echo $page_title; ?><?php echo $page_subtitle; ?><a href="javascript:history.go(-1)" class="gray_button title_back_button"><i></i>Back</a></h1>
        <div class="mtshad"></div>
    </div>
    <div class="holder_sidecontent clearfix">
        <?php include('includes/submenu_schedule.php'); ?>
