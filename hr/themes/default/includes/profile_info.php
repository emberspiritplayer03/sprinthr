...
<div id="profile_tab">
   ...
   <!--  <div class="pt_notification"><a href="javascript:void(0)" id="btn-sync-data"> <span class="icon-refresh icon-white"></span> Sync </a></div> -->
    <?php echo $hdr_btn_sync_data; ?>
	<?php echo $hdr_notification; ?>    
    <ul>
