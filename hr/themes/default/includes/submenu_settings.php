    ...
    <ul class="ulmenu">
        ...
        <li class="selected">
            ...
            <ul id="personal_information_submenu" class="ulsubmenu">
                ...
                <li id="dependents_nav"class="left_nav <?php echo $user_management_ra; ?>"><a href="<?php echo url('settings/requests_approvers');  ?>" onclick="javascript:hashClick('#dependents');">Requests Approvers</a></li>
                <li id="bank_nav" class="left_nav <?php echo $ip_management_sb; ?>" style = "display: none"><a href="<?php echo url('settings/ip_management');  ?>">IP Management</a></li>  
                <li id="personal_details_nav" class="left_nav <?php echo $payroll_settings_sb; ?>"><a href="<?php echo url('settings/payroll_settings');  ?>" onclick="javascript:hashClick('#personal_details');">Payroll</a></li>
                <li id="personal_details_nav" class="left_nav <?php echo $overtime_settings_sb; ?>"><a href="<?php echo url('overtime_settings');  ?>" >Overtime</a></li>
                <li id="personal_details_nav" class="left_nav <?php echo $leave_settings_sb; ?>"><a href="<?php echo url('settings/leave');  ?>" >Leave</a></li>
                <li id="personal_details_nav" class="left_nav <?php echo $payslip_settings_sb; ?>"><a href="<?php echo url('settings/payslip');  ?>" >Payslip</a></li>
                <!-- <li id="performance_nav" class="left_nav <?php echo $deduction_breakdown_sb; ?>"><a href="<?php //echo url('settings/options?sidebar=11');  ?>" onclick="javascript:hashClick('#deduction_breakdown');">Contribution</a></li> -->
                <li id="bank_nav"class="left_nav <?php echo $contribution_sb; ?>"><a href="<?php echo url('settings/contribution');  ?>" onclick="javascript:hashClick('#bank');">Contributions</a></li>
                <li id="breaktime_settings_nav" class="left_nav <?php echo $breaktime_settings_sb; ?>"><a href="<?php echo url('settings/breaktime_schedule');  ?>">Break Time Schedules</a></li>
                ...
                <li id="bank_nav"class="left_nav <?php echo $notifications_sb; ?>"><a href="<?php echo url('settings/notifications');  ?>" onclick="javascript:hashClick('#bank');">Notifications</a></li>
                <li id="leave_type_nav" class="left_nav <?php echo $project_history_status_sb; ?>"><a href="<?php echo url('settings/options?sidebar=15');  ?>" onclick="javascript:hashClick('#employment_status');">Projects History</a></li>
                <li id="leave_type_nav" class="left_nav <?php echo $activity_history_status_sb; ?>"><a href="<?php echo url('settings/options?sidebar=16');  ?>" onclick="javascript:hashClick('#employment_status');">Activity History</a></li>
            </ul>
        </li>
        <li class="selected">
            <div class="tabtitle">
...
<!--                 <li id="compensation_nav"class="left_nav <?php echo $dependent_relation_sb; ?>"><a href="<?php echo url('settings/options?sidebar=2');  ?>" onclick="javascript:hashClick('#compensation');">Dependent Relationship</a></li>   -->                   
                ...
                <li id="supervisor_nav"class="left_nav <?php echo $location_sb; ?>" style= "display: none"><a href="<?php echo url('settings/options?sidebar=6');  ?>" onclick="javascript:hashClick('#supervisor');">Location</a></li>
