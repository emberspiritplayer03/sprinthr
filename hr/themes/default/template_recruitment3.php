...
<div id="content" class="fullwidth">
	<div class="mtcntnr">
        ...
        <?php if($can_manage) { ?>
        <a class="add_button" id="applicant_examination_button" href="#" onclick="javascript:load_add_applicant_examination();"><strong>+</strong><b>Add Applicant Examination</b></a>
        <?php } ?>
        <a class="gray_button title_back_button" href="javascript:history.go(-1)"><i></i>Back</a></h1><div class="mtshad"></div>
    </div>
