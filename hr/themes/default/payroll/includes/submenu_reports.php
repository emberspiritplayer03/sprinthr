<div id="sidebar" class="sidebar_left">
    ...
    <ul class="ulmenu">        
      ...
      <li class="selected">
        ...
        <li class="selected">
            <?php if(!empty($btn_payslip) || !empty($btn_cost_center) ) { ?>
            	<div class="tabtitle">
                ...
                <ul id="employment_information_submenu" class="ulsubmenu">                 
                    ...
                    <?php echo $btn_payslip; ?>
                    <?php echo $btn_cost_center; ?>
                    <!-- <?php echo $btn_payroll_register; ?> -->
                   <?php echo $btn_yearly_bonus;?> 
                    <?php echo $btn_cash_file; ?>
                    <?php echo $btn_leave_converted_config; ?> 
                    <!-- <?php echo $btn_other_earnings_config; ?> -->
                </ul>
            <?php } ?>
            <br/>
            <?php if(!empty($btn_sss) || !empty($btn_philhealth) || !empty($btn_pagibig) || !empty($btn_tax) ) { ?>
                <div class="tabtitle">
                    <a id="employment_information_tab"  style="cursor:pointer">Contribution<!-- <img id="employment_information_min_button" class="subdropicon" src="<?php //echo BASE_FOLDER; ?>themes/<?php //echo THEME; ?>/themes-images/submenu_down_icon.png" /><img id="employment_information_max_button" class="subdropicon" src="<?php //echo BASE_FOLDER; ?>themes/<?php //echo THEME; ?>/themes-images/submenu_left_icon.png" style="display:none" /> --></a>
                </div>
                <ul id="employment_information_submenu" class="ulsubmenu">
                    <?php echo $btn_sss;?>
                    <?php echo $btn_philhealth;?>
                    <?php echo $btn_pagibig;?>
                    <?php echo $btn_tax;?> 
                    <?php echo $btn_annual_tax; ?>
                     <?php echo $btn_alpha_list;?>
                    <?php echo $btn_bir_2316;?>
                    <!--<li id="contribution_nav" class="left_nav"><a href="#contribution" onClick="javascript:hashClick('#contribution');">Contribution</a></li>-->                
                </ul>
            <?php } ?>
        </li>     
