...
<?php $url_param = "from=".$_GET['from']."&to=".$_GET['to']."&hpid=".$_GET['hpid']; ?>
    ...
    <ul class="ulmenu">
        ...
        <li class="selected">
            <ul id="personal_information_submenu" class="ulsubmenu">
                <li <?php echo $recent; ?> id="personal_details_nav" class="left_nav"><a href="<?php echo url('loan');  ?>">Loans</a></li>                
                <li <?php echo $history; ?> id="contact_details_nav" class="left_nav"><a href="<?php echo url('loan/history');  ?>">Employee Loan History</a></li>               
                <li <?php echo $loan_type; ?> id="emergency_contacts_nav" class="left_nav"><a href="<?php echo url('loan/loan_type');  ?>">Loan Type Management</a></li>
    ...
    <ul class="ulmenu">
        ...
        <li class="selected">
            <ul id="personal_information_submenu" class="ulsubmenu">
                ...
                <li <?php echo $approved; ?> id="personal_details_nav" class="left_nav"><a href="<?php echo url('earnings/approved?from=' . $period['from'] . "&to=" . $period['to'] . "&hpid=" . $period['hpid']);  ?>">Earnings</a></li>                
    ...
    <ul class="ulmenu">
        ...
        <li class="selected">
            <ul id="personal_information_submenu" class="ulsubmenu">                 
                <li <?php echo $approved; ?> id="personal_details_nav" class="left_nav"><a href="<?php echo url('deductions/approved?from=' . $period['from'] . "&to=" . $period['to'] . "&hpid=" . $period['hpid']);  ?>">Deductions</a></li>
                <li <?php echo $hold; ?> id="personal_details_nav" class="left_nav"><a href="<?php echo url('deductions/hold?from=' . $period['from'] . "&to=" . $period['to'] . "&hpid=" . $period['hpid']);  ?>">Hold Deductions</a></li>                              
