    ...
    <tbody>
      <?php foreach ($employees as $e):?>
        <tr>
          ...
          <td><a href="<?php echo url('attendance/show_attendance?employee_id='. Utilities::encrypt($e->getId()) .'&hash='. $e->getHash() .'&from='. $start_date .'&to='. $end_date);?>"><?php echo $e->getLastname();?>  <?php echo $e->extension_name;?> , <?php echo $e->getFirstname();?> <?php echo $e->middlename[0]; ?>. </a></td>
<!--          <td>3</td>
          <td>5</td>
          <td>8</td>
          <td>3</td>-->
