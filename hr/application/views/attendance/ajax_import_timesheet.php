...
<div id="form_main" class="inner_form popup_form">
    ...
    <div class="import_links">
        <small>
            <a href="<?php echo MAIN_FOLDER ."files/sample_import_files/attendance/import_dtr_template.xlsx"; ?>" class="btn btn-mini btn-link"><i class="icon-excel icon-custom icon-fade"></i> Download template</a>
        </small>
    </div>
