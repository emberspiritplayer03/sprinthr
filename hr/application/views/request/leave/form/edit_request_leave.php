...
<input type="hidden" name="leave_request_id" id="leave_request_id" value="<?php echo Utilities::encrypt($leave->getId()); ?>" />   
    ...
    <div id="form_default">      
        <table>             
            ...
            <tr>
            	<td class="field_label no-padding">&nbsp;</td>
            	<td class="no-padding"><div id="show_leave_available_wrapper"></div></td>            
            </tr>
            <!--<tr>
            ...
            <tr>-->
              ...
              <input style="margin:0 5px 0 0;" <?php echo($leave->getApplyHalfDayDateStart() == G_Employee_Leave_Request::YES ? 'checked="checked"' : ''); ?> value="1" type="checkbox" name="start_halfday" id="edit_start_halfday" onclick="javascript:wrapperEditComputeDaysWithHalfDay('edit_start_halfday','edit_end_halfday','edit_number_of_days');" />Apply Halfday             
              </label>
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                <label class="checkbox inline">
                <input style="margin:0 5px 0 0;" <?php echo($leave->getApplyHalfDayDateEnd() == G_Employee_Leave_Request::YES ? 'checked="checked"' : ''); ?> value="1" type="checkbox" name="end_halfday" id="edit_end_halfday" onclick="javascript:wrapperEditComputeDaysWithHalfDay('edit_start_halfday','edit_end_halfday','edit_number_of_days');" />Apply Halfday
                </label>
              </td>
            </tr>
            <tr>
