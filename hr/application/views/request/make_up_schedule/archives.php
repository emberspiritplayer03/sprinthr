...
<form name="withSelectedAction" id="withSelectedAction">
    <div align="left" style="float:left;">
    	<select disabled="disabled" name="chkAction" id="chkAction" onchange="javascript:makeUpScheduleWithSelectedAction(this.value);">
            <option value="">With Selected:</option>                  
            <option value="restore">Restore Archived</option>                    
        </select>
    </div>   
    <div class="clear"></div> 
    <div id="make_up_schedule_list_dt_wrapper" class="dtContainer"></div>   
</form>
<script>
