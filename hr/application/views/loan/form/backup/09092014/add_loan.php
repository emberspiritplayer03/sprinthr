    ...
    <div id="form_default">      
        <table width="100%">
             ...
             <tr>
               ...
               <td>
               		<input onchange="javascript:getEndDate('no_of_installment','type_of_deduction_id','start_date','end_date');" style="width:55px;margin-right:6px;" class="validate[required,custom[integer]]" type="text" name="no_of_installment" id="no_of_installment" value="" />
               </td>
             </tr>   
             <tr>
               <td class="field_label">Start Date:</td>
               <td>
               		<input class="validate[required]" type="text" name="start_date" id="start_date" value="<?php echo date("Y-m-d"); ?>" />
               </td>
             </tr>
             <tr>
               <td class="field_label">End Date:</td>
               <td>
               		<input class="validate[required]" readonly="readonly" type="text" name="end_date" id="end_date" value="" />
               </td>
             </tr>            
             <tr>
