...
$(function() {
	  var oTable = $('#loan_list').dataTable({   
	   "aoColumns": [
		...
		"bPaginate": true,			
		'sAjaxSource': base_url + 'loan/_load_server_loan_archive_list_dt',
...
<table id="loan_list" class="display">
    <thead>
      <tr>
      	<?php if($permission_action == Sprint_Modules::PERMISSION_02)	{	?>
      		<th valign="middle" width="2%"><input title="Check All" type="checkbox" id="check_uncheck" name="check_uncheck" onclick="chkUnchk(1);" /></th>     
      	<?php } ?>
