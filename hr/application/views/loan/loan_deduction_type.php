...
<div class="break-bottom inner_top_option">    
    <div class="datatable_withselect display-inline-block right-space">
        <select disabled="disabled" name="chkAction" id="chkAction" onchange="javascript:loanDeductionTypeWithSelectedAction(this.value);">
            <option value="">With Selected:</option>            
            <option value="loan_deduction_type_archive">Send to Archive</option>                    
        </select>
    </div>    
    <div class="clear"></div>
</div>
