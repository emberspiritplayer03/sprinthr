...
<div id="formwrap">
    ...
    <div id="form_main">
        ...
        <div id="form_default">            
          ...
          <tr>
            <td valign="top" class="field_label">Extension Name:</td>
            <td><input type="text" value="" name="extension_name" class="text-input text" id="extension_name" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" value="" name="email_address" class="text-input text" id="email_address" /></td>
          </tr>
          <tr>
        ...
        <a class="btn btn-small" id="view_other_personal_information_button_wrapper" href="#other_personal_information_form_wrapper" onclick="javascript:view_other_personal_information();" ><i class="icon-chevron-down"></i> View Other Personal Information</a>
        <a class="btn btn-small active" style="display:none" id="hide_other_personal_information_button_wrapper" onclick="javascript:hide_other_personal_information();" href="javascript:void(0);"><i class="icon-chevron-up"></i> Hide Other Personal Information</a>
              ...
              <tr>
                ...
                <td align="left" valign="top">
                	<select id="country" name="country">
                        ...
                        <option value="<?php echo $l->getLocation(); ?>"><?php echo $l->getLocation(); ?></option>
                        <?php } ?>
                    </select>
                </td>
              </tr>
        ...
        <div class="form_separator"></div>
          <a class="btn btn-small" id="view_contact_details_button_wrapper" onclick="javascript:view_contact_details();" href="javascript:void(0);"><i class="icon-chevron-down"></i> View Contact Information </a>
          <a class="btn btn-small active" style="display:none" id="hide_contact_details_button_wrapper" onclick="javascript:hide_contact_details();" href="javascript:void(0);"><i class="icon-chevron-up"></i> Hide Contact Information </a>
        <div class="clear"></div><br />
