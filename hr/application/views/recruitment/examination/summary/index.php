<div id="detailscontainer" class="detailscontainer_blue">
                    ...
                    <div class="col_3_4">
                        <table>
                          ...
                          <tr>
                            ...
                            <td class="bold"><?php echo Date::convertDateIntIntoDateString($examination->date_taken); ?></td>
                          </tr>
                        </table>
                    </div>
                    <div class="clear"></div>
    ...
    <br />
    <div align="center"><button type="button" class="blue_button" onclick="javascript:loadExamViewDialog();" /><i class="icon-ok icon-white"></i> OK</button></div>
</div>
