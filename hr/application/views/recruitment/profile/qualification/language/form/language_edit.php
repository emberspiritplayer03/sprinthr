...
<form id="language_edit_form" name="form1" method="post" action="<?php echo url('recruitment/_update_language'); ?>" >
    ...
    <tr>
       ...
       <td>
       		<select id="language" name="language">
            	<?php foreach($g_languages as $l){ ?>
                	<option <?php echo ($l->getLanguage() == $details->language ? 'selected="selected"' : ''); ?> value="<?php echo $l->getLanguage(); ?>"><?php echo $l->getLanguage(); ?></option>
                <?php } ?>
            </select>       
       </td>
    </tr>
     <tr>
       ...
       <td><select name="fluency" class="select_option" id="fluency">
     ...
     <tr>
       ...
       <td><select name="competency" class="select_option" id="competency">
