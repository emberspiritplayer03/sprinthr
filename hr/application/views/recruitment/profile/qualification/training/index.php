<h2 class="field_title"><?php echo $title_training; ?><a class="add_button" id="training_add_button_wrapper" href="javascript:loadTrainingAddForm();"><strong>+</strong><b>Add Training</b></a></h2>
