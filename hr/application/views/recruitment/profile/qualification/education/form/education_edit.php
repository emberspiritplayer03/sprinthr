<script>
$("#edit_educ_start_date").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
$("#edit_educ_end_date").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
...
<form id="education_edit_form" name="form1" method="post" action="<?php echo url('recruitment/_update_education'); ?>" >
...
<div id="form_default">
  <table>
    ...
    <tr>
      ...
      <td><input type="text" class="validate[required] text-input" name="start_date" id="edit_educ_start_date" value="<?php echo $details->start_date; ?>" /></td>
    </tr>
    <tr>
      <td class="field_label">End Date:</td>
      <td><input type="text" class="validate[required] text-input" name="end_date" id="edit_educ_end_date" value="<?php echo $details->end_date; ?>" /></td>
    </tr>
    <tr>
