...
<form id="skill_add_form" name="form1" method="post" action="<?php echo url('recruitment/_update_skill'); ?>">
      ...
      <td>
      	<select name="skill" id="skill">
       		<?php foreach($g_skills as $s){ ?> 
            	<option value="<?php echo $s->getSkill(); ?>"><?php echo $s->getSkill(); ?></option>
            <?php } ?>
        </select>      	
      </td>
    </tr>
