...
<form id="license_add_form" name="form1" method="post" action="<?php echo url('recruitment/_update_license'); ?>">
...
<div id="form_default">
  <table>
      ...
      <td>
      	...
      	<?php foreach($g_licenses as $l){ ?>
        	<option value="<?php echo $l->getLicenseType(); ?>"><?php echo $l->getLicenseType(); ?></option>
        <?php } ?>
        </select>      	
      </td>
    </tr>
    ...
    <tr>
      ...
      <td><input class="text-input" type="text" name="issued_date" id="issued_date" /></td>
    </tr>
    <tr>
