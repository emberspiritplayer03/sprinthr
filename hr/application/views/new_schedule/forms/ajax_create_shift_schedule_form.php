        ...
        <div id="form_default">
            <table class="no_border" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <input class="validate[required] time_in" name="time_in" value="<?php echo $time_in; ?>" onchange="onStartTimeChanged(<?php echo 1; ?>)" type="text" id="shift_start_time_<?php echo 1; ?>" style="width:60px" />
                    </td>
                </tr>
                <tr>
                    <td class="field_label">*Time Out:</td>
                    <td>
                        <input class="validate[required]" name="time_out" value="<?php echo $time_out; ?>" onchange="onEndTimeChanged(<?php echo 1; ?>)" type="text" id="shift_end_time_<?php echo 1; ?>" style="width:60px" />
                    </td>
                </tr>
                <?php
                $clear_link_visible = '';
...
<script>
    ...
    function onStartTimeChanged(number) {
        var start_time_id = '#shift_start_time_' + number;
        var end_time_id = '#shift_end_time_' + number;
        var start_time = $('#shift_start_time_' + number).val();
    ...
    for (i = 1; i <= 7; i++) {
        $('#shift_start_time_' + i).timepicker({
            'minTime': '6:00 am',
            'maxTime': '5:30 am',
            'timeFormat': 'g:i a'
        });
        $('#shift_end_time_' + i).timepicker({
            'minTime': '6:00 am',
            'maxTime': '5:30 am',
            'timeFormat': 'g:i a'
        });
