...
$(function(){
  $(".btn-show-dept-section-schedule").click(function(){
     ...
     location.href = base_url + 'new_schedule/show_department_schedule?eid=' + eid; 
  });
});
</script>
    ...
    <tbody>
      <?php foreach ($employees as $e):?>
        <tr>
          ...
          <td>
            <div><a class="link_option" href="<?php echo url('new_schedule/show_employee_schedule?eid='. Utilities::encrypt($e->getId()) .'&hash='. $e->getHash());?>" title="Show Schedules">Show Schedules</a></div>
          </td>          
        </tr>
      <?php endforeach;?>
    </tbody>
