...
<script type="text/javascript">
	$(function() {
        ...
        $("#tabs").tabs({});
		load_compress_schedule("#schedule");


		$(".no_schedule").click(function(){
			load_no_compress_schedule('#no_schedule');
		});
        $(".leave").click(function(){
			load_leave_compress_schedule('#leave');
		});
        $(".rest_day").click(function(){
			load_rest_day_compress_schedule('#rest_day');
		});
        $(".ob").click(function(){
            load_ob_compress_schedule('#official_business');
		});
        $(".rules").click(function(){

		});
        $(".employee").click(function(){
            load_compressed_schedule_employee_list_dt();
		});
        $(".schedule").click(function(){
			load_compressed_schedule_list_dt();
		});
                ...
                <div id="form_default">
                    ...
                    <table class="no_border" width="100%">
                        <tr>
                            ...
                            <td><input style="width:3%;" class="validate[required]" type="number" name="hours" id="hours" value="<?php echo $hours; ?>" /> Hours Per Week</td>
                        </tr>
                    </table>
                </div>
