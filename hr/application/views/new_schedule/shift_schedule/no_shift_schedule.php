...
<div id="employee_search_container" style="overflow:visible !important; padding-bottom:15px;">
    <div class="employee_basic_search searchcnt" id="search_wrapper">
        ...
        <button class="blue_button" onclick="javascript:load_no_shift_schedule_dt();"><i class="icon-search icon-white"></i> Search</button>
...
<div>
    <div class="dt_top_nav">
        ...
        <div class="dt_limit">Limit :
            <select id="dt_limit" style="width:50px;" onchange="javascript:load_no_shift_schedule_dt();">
    ...
    <table id="" class="formtable">
        ...
        <tbody id="no_shift_schedule_dt_wrapper">
        </tbody>
    </table>
    <div class="paginator yui-skin-sam"></div>
</div>
