...
<script type="text/javascript">
	$(function() {
		...
		$(".no_schedule").click(function(){
			load_no_staggered_schedule('#no_schedule');
		});
        $(".leave").click(function(){
			load_leave_staggered_schedule('#leave');
		});
        $(".rest_day").click(function(){
			load_rest_day_staggered_schedule('#rest_day');
		});
        $(".ob").click(function(){
            load_ob_staggered_schedule('#official_business');
		});
