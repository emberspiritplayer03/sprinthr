...
<script>
    $(function() {
        ...
        $("#autocomplete").hide();
        $("#all_emp").show();
        load_staggered_schedule_dt();
        //$("table").tablesorter();

        var emp_selected = new $.TextboxList('#emp_selected_staggered', {
            unique: true,
            plugins: {
                autocomplete: {
                    minLength: 1,
    ...
    <div class="employee_basic_search searchcnt" id="search_wrapper">
        ...
        <div class="float-left">
            ...
            <div id="autocomplete" class="float-left">
                <input type="text" name="emp_selected" id="emp_selected_staggered" />
            </div>
            <div class="clear"></div>
        ...
        <button class="blue_button" onclick="javascript:load_staggered_schedule_dt();"><i class="icon-search icon-white"></i> Search</button>
...
<div>
    <div class="dt_top_nav">
        ...
        <div class="dt_limit">Limit :
            <select id="dt_limit" style="width:50px;" onchange="javascript:load_staggered_schedule_dt();">
    ...
    <div class="group-2">
        <div class="dt_top_nav">
            <select name="chkAction" id="chkAction" onchange="javascript:withSelectedLogsAll(this.value);" disabled="disabled">
    ...
    <table id="" class="formtable">
        ...
        <tbody id="staggered_schedule_dt_wrapper">
        </tbody>
    </table>
    <div class="paginator yui-skin-sam"></div>
</div>
