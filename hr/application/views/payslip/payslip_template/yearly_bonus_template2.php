...
<?php
    ...
    $thirteent_month_bonus_tax = 0;
    $thirteent_month_bonus_tax += $payslip_section_deduction['bonus_/_service_award_witholding_tax']['value'];
...
<?php if(!empty($payslip_section_yearly_bonus['yearly_bonus']['value']['tax']) && $payslip_section_yearly_bonus['yearly_bonus']['value']['tax'] > 0) { ?>
      <td class=xl96 style="font-size:13.5pt;mso-number-format:'\@';text-align:right;" align=right><?php echo number_format($payslip_section_yearly_bonus['yearly_bonus']['value']['tax'], 2) ?></td>
<?php }else{ ?>
      <td class=xl96 style="font-size:13.5pt;mso-number-format:'\@';text-align:right;" align=right><?php echo number_format($thirteent_month_bonus_tax, 2) ?></td>
<?php } ?>
...
<?php
  ...
  if($tax_bonus == 0) {
    $tax_bonus = $thirteent_month_bonus_tax;
  }
...
<td class=xl99 style="font-size:14pt;mso-number-format:'\@';text-align:right;" align="right">0.00</td>
<td class=xl96 style='font-size:14pt;'>13TH MO.:</td>
...
<td class=xl116 style="font-size:13.5pt;mso-number-format:'\@';text-align:right;" align="right"><?php echo number_format($bonus - $thirteent_month_bonus_tax,2); ?></td>
...
<td class=xl103 style="font-size:13.5pt;mso-number-format:'\@';text-align:right;" align="right"><?php echo number_format($tax_bonus + $payslip_yearly_breakdown['y_withheld_tax'],2); ?></td>
<td class=xl104 style='font-size:13.5pt;'>TOTAL SALARY:</td>
<td class=xl105 style="font-size:13.5pt;mso-number-format:'\@';text-align:right;" align="right"><?php echo number_format($bonus - $thirteent_month_bonus_tax,2); ?></td>
