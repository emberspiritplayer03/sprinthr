...
<?php
  $row_number = 1;
?>
<?php foreach ($employees as $e_key => $e): ?>
...
<?php
    ...
    $custom_bonus_a = 0;
    $service_award  = 0;
    $add_13th_month_to_net_pay          = 0;
    $bonus_service_award_witholding_tax = 0;
    $add_13th_month_tax = 0;
  
    if($add_13th_month) {
      if( isset($payslip_section_other_earnings['13th_month_bonus']) ){
        $add_13th_month_to_net_pay = $payslip_section_other_earnings['13th_month_bonus']['value'];
      } 
    }
    ...
    $net_pay = ($net_pay + $add_13th_month_to_net_pay) - ($custom_bonus_a + $service_award);
    if($add_bonus_service_award){
      $net_pay -= $bonus_service_award_witholding_tax;
    }
    $union_dues_and_agency_fees = 0;
    ...
    foreach( $payslip_section_loan_balance as $key => $loan_balance ){
      switch ($key) {
        case 'pagibig_loan':
          ...
          break;
        case 'pagibig_calamity_loan':
          $pagibig_loan_balance += $loan_balance['value'] - $payslip_section_deduction['pagibig_calamity_loan']['value'];          
          break;
        case 'pagibig_salary_loan':
          $pagibig_loan_balance += $loan_balance['value'] - $payslip_section_deduction['pagibig_salary_loan']['value'];          
          break;          
        case 'sss_loan':
          $sss_loan_balance = $loan_balance['value'] - $payslip_section_deduction['sss_loan']['value'];
          break;
        case 'sss_salary_loan':
          $sss_loan_balance += $loan_balance['value'] - $payslip_section_deduction['sss_salary_loan']['value'];
          break;    
        case 'sss_calamity_loan':
          $sss_loan_balance += $loan_balance['value'] - $payslip_section_deduction['sss_calamity_loan']['value'];
          break;                    
        case 'salary_loan':
    ...
    if( isset($payslip_section_yearly_bonus['yearly_bonus']) ){
      $tax_bonus += $payslip_section_yearly_bonus['yearly_bonus']['value']['tax'];
    }
    ...
    $union_dues_and_agency_fees = ($payslip_section_deduction['union_dues']['value'] + $payslip_section_deduction['agency_fee']['value']);    
?>
...
<td class=xl96 style="font-size:13.5pt;mso-number-format:'\@';text-align:right;" align=right><?php echo number_format(($payslip_section_deduction['witholding tax']['value'] + $add_13th_month_tax),2, '.' , ',' ); ?></td>
...
<td class=xl96 style="font-size:14pt;mso-number-format:'\@';text-align:right;" align=right><?php echo number_format($payslip_section_deduction['sss_loan']['value'] + $payslip_section_deduction['sss_calamity_loan']['value'] + $payslip_section_deduction['sss_salary_loan']['value'],2, '.' , ',' ); ?></td>
...
<td class=xl96 style="font-size:14pt;mso-number-format:'\@';text-align:right;" align=right><?php echo number_format($payslip_section_deduction['pagibig_loan']['value'] + $payslip_section_deduction['pagibig_calamity_loan']['value'] + $payslip_section_deduction['pagibig_salary_loan']['value'],2, '.' , ',' ); ?></td>
...
<?php
  ...
  $exist_deductions   = array('emergency_loan','salary_loan','hmo','sss_loan','adjustment','witholding tax','philhealth','pagibig','sss','absent_amount','undertime_amount','late_amount','company_loan','education_loan','union_dues','agency_fee');
  foreach($payslip_section_deduction as $deduction_key => $e_deduction) {
    $is_exists = false;
  ...
  if($add_13th_month) {
    if( isset($payslip_section_other_earnings['13th_month_bonus']) ){
      //$other_earnings += $payslip_section_other_earnings['13th_month_bonus']['value'];
    } 
  }
  ...
  $bonus = 0;
  $add_13th_month_to_total_other_earnings = 0;
  if( isset($payslip_section_other_earnings['13th_month_bonus']) ){
    if($add_13th_month) {
  ...
  */
  ...
  if($add_bonus_service_award){
     $total_other_deduction_key += $bonus_service_award_witholding_tax;
  }
  /*$other_earnings = 0;
  ...
  if($add_bonus_service_award == 1){
     $other_earnings += $service_award;
     $bonus += $custom_bonus_a;
     $net_pay += ($service_award+$custom_bonus_a);
  }
?>
<tr>
...
<td class=xl97 style='font-size:13.5pt;'>UNION DUES/AGENCY FEE :</td>
<td class=xl96 style="font-size:13.5pt;mso-number-format:'\@';text-align:right;" align="right"><?php echo number_format($union_dues_and_agency_fees,2,'.' , ','); ?></td>
...
<td class=xl96 style='font-size:14pt;'>OT ALLOWANCE :</td>
<td class=xl96 style="font-size:14pt;mso-number-format:'\@';text-align:right;" align="right"><?php echo number_format($payslip_section_other_earnings['ot_allowance']['value'],2, '.' , ',' ); ?></td>
...
<?php if($show_converted_leaves_only == 1) { ?>
        <?php
          $total_other_earnings = ($payslip_section_other_earnings['ot_allowance']['value'] + $meal_transpo_earnings + $other_earnings + $rice_earnings + $bonus_leave_converted + $add_13th_month_to_total_other_earnings);
        ?>
<?php } else { ?>
        <?php
          $total_other_earnings = ($payslip_section_other_earnings['ot_allowance']['value'] + $meal_transpo_earnings + $other_earnings + $rice_earnings + $yearly_bonus_amount + $add_13th_month_to_total_other_earnings);
        ?>
<?php } ?>

<?php 
  if($add_bonus_service_award){
    $total_other_earnings +=  $custom_bonus_a;
...
<td class=xl103 style="font-size:13.5pt;mso-number-format:'\@';text-align:right;" align="right"><?php echo number_format($payslip_yearly_breakdown['y_withheld_tax'] + $tax_bonus,2, '.' , ',' ); ?></td>
