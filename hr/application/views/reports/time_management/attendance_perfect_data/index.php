...
$("#perfect_date_from").datepicker({	
	dateFormat:'yy-mm-dd',
	changeMonth:true,
	changeYear:true,
	showOtherMonths:true,
	onSelect	:function() { 
		$("#perfect_date_to").datepicker('option',{minDate:$(this).datepicker('getDate')});
	}
});	

$("#perfect_date_to").datepicker({	
	dateFormat:'yy-mm-dd',
	changeMonth:true,
	changeYear:true,
	showOtherMonths:true,
...
$(function(){
    $("#frm-report-attendance-perfect").validationEngine({scroll:false}); 
});
</script>
<div id="form_main" class="employee_form">
<form id="frm-report-attendance-perfect" name="form1" method="post" action="<?php echo url('reports/download_perfect_attendance_data'); ?>">
     <div id="form_default">
        <h3 class="section_title">Date Applied</h3>
        <table width="100%">
            <tr>
                <td class="field_label">From:</td>
                <td><input type="text" id="perfect_date_from" class="validate[required]" name="perfect_date_from" /></td>
            </tr>
            <tr>
                <td class="field_label">To:</td>
                <td><input type="text" id="perfect_date_to" class="validate[required]"  name="perfect_date_to"  /></td>
            </tr>
            <tr>
                <td class="field_label">Late Minutes (less than or equal):</td>
                <td><input type="number" id="late_minutes" class="validate[required]"  name="late_minutes" min="0" /></td>
            </tr>
    	</table>
    </div>
