<table width="100%" border="0" cellpadding="2" cellspacing="1" style="font-size:8pt; width:836pt; line-height:16pt;">	
	<tr>
        ...
        <strong>
        	<?php echo($report_body_type == DETAILED ? "Detailed : Incomplete Time In / Out Data" : "Summarized : Incomplete Time In / Out Data"); ?>
        </strong>
        </td>
    	<td style="border:none;">&nbsp;</td>
    </tr> 
     <tr>
        <td style="border:none; font-size:14pt;" align="left"><strong>Filter By:</strong></td>
