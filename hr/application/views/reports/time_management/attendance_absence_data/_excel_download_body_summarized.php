...
<table border="1" cellpadding="2" cellspacing="1" style="font-size:9pt; width:836pt; line-height:12pt;">
	<tr>
        ...
        <td align="center" valign="top" style="border-bottom:none;"><strong>Total Absent</span></strong></td>            
    </tr>
	<?php 
		$total_absent = 0;
	...
	?>
    	<tr>
            ...
            <td align="right" valign="top" style="border-bottom:none;"><?php echo $a['total_absent']; ?></td>           
        </tr>
    <?php } ?>
    <tr>
    	<td colspan="6" align="left" valign="top" style="border-bottom:none;"><b>Total</b></td>
        <td align="right" valign="top" style="border-bottom:none;vertical-align:middle;mso-number-format:'\@';"><?php echo number_format($total_absent,0); ?></td>
    </tr>
</table>