...
<script>
$("#resigned_date_from").datepicker({	
	dateFormat:'yy-mm-dd',
	changeMonth:true,
	changeYear:true,
	showOtherMonths:true,
	onSelect	:function() { 
		$("#resigned_date_to").datepicker('option',{minDate:$(this).datepicker('getDate')});
	}
});	

$("#resigned_date_to").datepicker({	
	dateFormat:'yy-mm-dd',
	changeMonth:true,
	changeYear:true,
	showOtherMonths:true,
...
$(function(){
    $("#frm-report-resigned-employees").validationEngine({scroll:false}); 
});
</script>
<div id="form_main" class="employee_form">
<form id="frm-report-resigned-employees" name="form-resigned-employees" method="post" action="<?php echo url('reports/download_resigned_employees_data'); ?>">
     <div id="form_default">
        <h3 class="section_title">Date Applied</h3>
        <table width="100%">
            <tr>
                <td class="field_label">From:</td>
                <td><input type="text" id="resigned_date_from" name="date_from" class="validate[required]" /></td>
            </tr>
            <tr>
                <td class="field_label">To:</td>
                <td><input type="text" id="resigned_date_to" name="date_to" class="validate[required]" /></td>
            </tr>
    	</table>
    </div>
