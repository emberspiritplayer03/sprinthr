...
<script>
$("#eoc_birthdate").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
$("#eoc_date_from").datepicker({	
	dateFormat:'yy-mm-dd',
	changeMonth:true,
	changeYear:true,
	showOtherMonths:true,
	onSelect	:function() { 
		$("#eoc_date_to").datepicker('option',{minDate:$(this).datepicker('getDate')});
	}
});	

$("#eoc_date_to").datepicker({	
	dateFormat:'yy-mm-dd',
	changeMonth:true,
	changeYear:true,
	showOtherMonths:true,
...
$(function(){
    $("#frm-report-eoc").validationEngine({scroll:false}); 
});
</script>
<div id="form_main" class="employee_form">
<form id="frm-report-eoc" name="form1" method="post" action="<?php echo url('reports/download_end_of_contract_data'); ?>">
     <div id="form_default">
        <h3 class="section_title">Date Applied</h3>
        <table width="100%">
            <tr>
                <td class="field_label">From:</td>
                <td><input type="text" id="eoc_date_from" name="date_from" class="validate[required]" /></td>
            </tr>
            <tr>
                <td class="field_label">To:</td>
                <td><input type="text" id="eoc_date_to" name="date_to" class="validate[required]" /></td>
            </tr>
    	</table>
    </div>
            ...
            <tr>
                ...
                <td class="form-inline">                
                    <div class="rep-checkbox-container">
                      <label class="checkbox"><input type="checkbox" name="eoc_remove_resigned" checked="checked" value="1" />Remove Resigned Employees</label> 
                      <label class="checkbox"><input type="checkbox" name="eoc_remove_terminated" checked="checked" value="1" />Remove Terminated Employees</label>
                      <!-- <label class="checkbox"><input type="checkbox" name="eoc_remove_endo" checked="checked" value="1" />Remove End of Contract</label> -->
                      <label class="checkbox"><input type="checkbox" name="eoc_remove_inactive" checked="checked" value="1" />Remove Inactive Employees</label>
                    </div>
                </td>
            </tr>                      
        </table>
