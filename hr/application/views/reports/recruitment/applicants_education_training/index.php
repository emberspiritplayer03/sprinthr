    ...
    <div id="form_default">
        ...
        <table width="100%">
            <tr>
                ...
                <td>
                <input class="text-input" type="text" name= "from_field"/>
                </td>
            </tr>
            <tr>
                <td class="field_label">To:</td>
                <td> 
                <input class="text-input" type="text" name= "to_field" />
                </td>
            </tr>
    	</table>
    </div>
    ...
    <div id="form_default">
        <table width="100%">
            ...
            <tr>
                ...
                <input class="text-input" type="text"  name="course_field" /></td>
            </tr>            
             <tr>
                <td class="field_label">Schools:</td>
                <td> 
                <input class="text-input" type="text" name="schools_field" />
                </td>
            </tr>
            <tr>
                <td class="field_label"></td>
                <td> 
                <label><input type="radio" name="radio_group1" value="Education" >Education </input></label>                
                <label><input type="radio"  name="radio_group1" value="Training" >Training </input></label>
                </td>
            </tr>
        </table>
    </div>
