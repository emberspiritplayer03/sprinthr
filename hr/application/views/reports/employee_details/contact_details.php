    ...
    <div id="form_default" class="form_col_1_2">    	
        <table>
          <tr>
            ...
            <td><?php echo $contact_details->address; ?></td>
          </tr>
          <tr>
            <td style="color:#777777; width:170px;">City:</td>
            <td><?php echo  ucfirst($contact_details->city); ?></td>
          </tr>
          <tr>
            <td style="color:#777777; width:170px;">Province:</td>
            <td><?php echo ucfirst($contact_details->province); ?></td>
          </tr>
          <tr>
            <td style="color:#777777; width:170px;">Zip Code:</td>
            <td><?php echo  ucfirst($contact_details->zip_code); ?></td>
          </tr>
          <tr>
            <td style="color:#777777; width:170px;">Country:</td>
            <td><?php echo  ucfirst($contact_details->country); ?></td>
          </tr>
          <tr>
            <td style="color:#777777; width:170px;">Home Telephone:</td>
            <td><?php echo  ucfirst($contact_details->home_telephone); ?></td>
          </tr>
        </table>
    </div><!-- #form_default -->
    </div><!-- .col_1_2 -->
    <div class="col_1_2">
        <div id="form_default" class="form_col_1_2">
            <table>
                ...
                <td><?php echo ucfirst($contact_details->mobile); ?></td>
              </tr>
              <tr>
                <td style="color:#777777; width:170px;">Work Telephone:</td>
                <td><?php echo $contact_details->work_telephone; ?></td>
              </tr>
              <tr>
                <td style="color:#777777; width:170px;">Work Email:</td>
                <td><?php echo $contact_details->work_email; ?></td>
              </tr>
              <tr>
                <td style="color:#777777; width:170px;">Other Email:</td>
                <td><?php echo $contact_details->other_email; ?></td>
              </tr>
