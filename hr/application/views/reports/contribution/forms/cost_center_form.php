...
<form id="payroll_register_form" name="form1" method="post" action="<?php echo url('payroll/download_cost_center'); ?>">
  ...
  <div id="form_default">
      <table width="100%">   
        ...
        <tr>
          ...
          <tr>
          <td colspan="2"><div class="form_separator"></div></td>
        </tr>
          <tr>
              <td>Report Type</td>
              <td>: 
                  <select name="report_type" id="report_type">
                      ...
                      <option value="detailed_counter_check">Counter Checking</option>
                  </select>                
              </td>
          </tr>
