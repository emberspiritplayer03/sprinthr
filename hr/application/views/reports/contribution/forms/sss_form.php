...
$(function(){
   ...
   $("#per_month").hide();
    ...
    $("#sss-report-type-selector").change(function(){ 

        if($("#sss-report-type-selector").val() == 'per_pay_period'){
  ...
  $("#sss-report-year-selector").change(function(){    
     changePayPeriodByYear(this.value,'sss-pay-period-container',$("#sss-report-frequency-selector").val());
  });

  $("#sss-report-frequency-selector").change(function(){    
     changePayPeriodByYear($("#sss-report-year-selector").val(),'sss-pay-period-container',this.value);
  });

  changePayPeriodByYear($("#sss-report-year-selector").val(),'sss-pay-period-container',$("#sss-report-frequency-selector").val());
});
</script>
<h2><?php echo $title;?></h2>
<form id="sss_form" name="sss_form" method="post" action="<?php echo url('reports/download_sss_report'); ?>">
      ...
      <table width="100%">
        <tr>
          ...
          <td class="form-inline">:
            <select id="sss-report-frequency-selector" name="frequency_id">
              <?php
        ...
        <tr>
          ...
          <td class="form-inline">:
            <select id="sss-report-year-selector" name="year_selecter">
        ...
        <tr>
          ...
          <td class="form-inline">:
            <select id="sss-report-type-selector" name="report_type">
        ...
        <tr id="per_pay_period">
            <td>Payroll Period</td>
            <td class="form-inline">: 
                <div class="sss-pay-period-container" style="display:inline-block;"></div><br />                               
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="form-inline">                
                <div class="rep-checkbox-container">
                  <label class="checkbox"><input type="checkbox" name="sss_remove_resigned" checked="checked" value="1" />Remove Resigned Employees</label> 
                  <label class="checkbox"><input type="checkbox" name="sss_remove_terminated" checked="checked" value="1" />Remove Terminated Employees</label>
                  <label class="checkbox"><input type="checkbox" name="sss_remove_endo" checked="checked" value="1" />Remove End of Contract</label>
                  <label class="checkbox"><input type="checkbox" name="sss_remove_inactive" checked="checked" value="1" />Remove Inactive Employees</label>
                </div>
            </td>
        </tr>
         <tr>
