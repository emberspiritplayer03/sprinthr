...
<table border="1" cellpadding="2" cellspacing="1" style="font-size:9pt; width:836pt; line-height:12pt;">
    <tr>
        ...
        <td align="center" valign="middle" style="width:90pt; vertical-align:middle;"><strong>Pag-IBIG ID/RTN</strong></td>
        <td align="center" valign="top" style="border-bottom:none;"><strong>Birthdate</strong></td>
        <td align="center" valign="top" style="border-bottom:none;"><strong>Last Name</strong></td>
        <td align="center" valign="top" style="border-bottom:none;"><strong>First Name</strong></td>
        <td align="center" valign="top" style="border-bottom:none;"><strong>Name Extension</strong></td>
        <td align="center" valign="top" style="border-bottom:none;"><strong>Middle Name</strong></td>                
        ...
        <td align="center" valign="top" style="border-bottom:none;"><strong>Loan Code</strong></td>       
        <td align="center" valign="top" style="border-bottom:none;"><strong>Amount</strong></td>    
    </tr>
    <?php 
        foreach($loans_data as $key => $l){
            ...
            $birthdate    = $l['employee_details']['birthdate'];
    ?>
        ...
        <tr>
            ...
            <td align="left" valign="top" style="border-bottom:none;mso-number-format:'\@';"><?php echo $l['employee_details']['pagibig_number']; ?></td>
            <td align="left" valign="top" style="border-bottom:none;"><?php echo $birthdate; ?></td>
            ...
            <td align="left" valign="top" style="border-bottom:none;"><?php echo $l['employee_details']['extension_name']; ?></td>
