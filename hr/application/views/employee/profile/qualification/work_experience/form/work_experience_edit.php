<script>
$("#edit_work_experience_from").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
$("#edit_work_experience_to").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
...
<div id="form_default">
  <table>
    ...
    <tr>
      ...
      <td><input type="text" class="validate[required] text-input" name="from_date" id="edit_work_experience_from" value="<?php echo $details->from_date; ?>" /></td>
    </tr>
    <tr>
      <td class="field_label">To:</td>
      <td><input type="text" class="validate[required] text-input" name="to_date" id="edit_work_experience_to" value="<?php echo $details->to_date; ?>" /></td>
    </tr>
    <tr>
...
<div class="form_action_section" id="form_default">
    <table>
    	<tr>
            ...
            <td>
            	<a class="delete_link red float-right" href="javascript:void(0);" onclick="javascript:loadWorkExperienceDialog('<?php echo Utilities::encrypt($details->id); ?>')"><span class="delete"></span>Delete Work Experience</a>
            	<input class="blue_button" type="submit" name="button" id="button" value="Update" />&nbsp;<a href="javascript:void(0);" onclick="javascript:loadWorkExperienceTable();">Cancel</a>
            </td>
    	</tr>
    </table>
