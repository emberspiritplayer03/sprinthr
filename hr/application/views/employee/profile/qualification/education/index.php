<h2 class="field_title"><?php echo $title_education; ?>
  <?php echo $btn_add_education; ?>
</h2>
        ...
        <tr>
          <td>
            <?php if($permission_action == Sprint_Modules::PERMISSION_02) { ?>
              <a href="javascript:void(0);" onclick="javascript:loadEducationEditForm('<?php echo $e->id; ?>');"><?php echo $e->institute; ?></a>
            <?php }else{ echo $e->institute; } ?>
          </td>
