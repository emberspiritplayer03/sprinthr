...
<form id="language_add_form" name="form1" method="post" action="<?php echo url('employee/_update_language'); ?>">
      ...
      <td>
      	<select name="language" id="language">
        	<?php foreach($g_language as $gl){ ?>
            	<option value="<?php echo $gl->getLanguage(); ?>"><?php echo $gl->getLanguage(); ?></option>
            <?php } ?>
        </select>      	
      </td>
    </tr>
