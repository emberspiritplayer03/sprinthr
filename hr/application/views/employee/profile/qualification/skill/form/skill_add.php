  ...
  <table>
      ...
      <td>
      	...
      	<?php foreach($g_skills as $gs){ ?>
        	<option value="<?php echo $gs->getSkill(); ?>"><?php echo $gs->getSkill(); ?></option>
        <?php } ?>
        </select>
      </td>
    </tr>
    <tr>
      ...
      <td><input class="validate[required,custom[money]] text-input" type="text" name="years_experience" id="years_experience" /></td>
    </tr>
    <tr>
