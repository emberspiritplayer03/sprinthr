<h2 class="field_title"><?php echo $title_attachment; ?>
  <?php echo $btn_add_attachment; ?>
</h2>
	   ...
	   foreach($attachment as $key=>$e) { ?>
        <tr>
          ...
          <?php if($permission_action == Sprint_Modules::PERMISSION_02) { ?>
              <a target="_blank" href="<?php echo FILES_FOLDER.$e->filename; ?>">Download</a> <a href="javascript:void(0);" onclick="javascript:loadAttachmentEditForm('<?php echo $e->id; ?>');"><?php echo $e->filename; ?></a>
          <?php }else{ ?>
              <a target="_blank" href="<?php echo FILES_FOLDER.$e->filename; ?>">Download</a> <?php echo $e->filename; ?>
          <?php } ?>
          </td>
