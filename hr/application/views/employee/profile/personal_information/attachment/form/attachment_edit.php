...
<form id="attachment_edit_form" name="form1" method="post" action="<?php echo url('employee/_update_attachment'); ?>" >
...
<div id="form_default">
  <table>
      ...
      <td>
      	<input readonly="readonly" class="validate[required] text-input" type="text" name="filename_current" id="filename_current" value="<?php echo $details->filename; ?>" /><br />
    ...
    <tr>
      ...
      <td><input class="validate[required] text-input" type="text" name="description" id="description" value="<?php echo $details->description; ?>" /></td>
    </tr>
    <tr>
      <td class="field_label">Date Attached:</td>
      <td>
      <input class="validate[required] text-input" type="text" name="date_attached" id="edit_date_attached" value="<?php echo  $details->date_attached; ?>" /></td>
    </tr>
  </table>
</div><!-- #form_default -->
