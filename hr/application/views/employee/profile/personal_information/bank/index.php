<h2 class="field_title"><?php echo $title_bank; ?>
<?php echo $btn_add_account; ?>
</h2>
...
<table width="858" id="hor-minimalist-b"  border="0">
	  ...
	  $ctr = 0;
	   foreach($banks as $key=>$e) { ?>
        <tr>
          <td><?php if($permission_action == Sprint_Modules::PERMISSION_02) { ?><a href="javascript:void(0);" onclick="javascript:loadDirectDepositEditForm('<?php echo $e->id; ?>');"><?php echo $e->bank_name; ?></a><?php } else {echo $e->bank_name;} ?></td>
