      ...
      <table>
        ...
        <tr>
          ...
          <td>
          	...
          	<?php foreach($g_countries as $gc){ ?>
            	<option <?php echo(ucfirst($details->country) == $gc->getLocation() ? 'selected="selected"' : ''); ?> value="<?php echo $gc->getLocation(); ?>"><?php echo $gc->getLocation(); ?></option>
            <?php } ?>
            </select>
          </td>
        </tr>
