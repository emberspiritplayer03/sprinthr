...
<input type="hidden" name="employee_id" value="<?php echo $employee_id; ?>" />
  ...
  <table class="table_form" width="476" border="0" cellpadding="3" cellspacing="3">
    ...
    <tr>
      ...
      <td width="241" valign="top"><input class="blue_button" type="submit" name="button" id="button" value="Add" />&nbsp;<a href="javascript:void(0);" onclick="javascript:loadWorkExperienceTable();">Cancel</a></td>
    </tr>
  </table>
</form>
