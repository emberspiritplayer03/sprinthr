...
<div id="form_default">
  <table>
    ...
    <tr>
      ...
      <td><input type="text" class="text-input"  name="end_date" id="job_history_to" value="<?php echo $details->end_date; ?>" /><br /><small style="font-size:11px;">Note : Leave it blank if current position</small></td>
    </tr>
  </table>
</div><!-- #form_default -->
