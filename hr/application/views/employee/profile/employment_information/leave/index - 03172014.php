<div class="sectionarea">
    ...
    <?php if($can_manage) { ?>
    	<a class="add_button" id="leave_available_add_button_wrapper" href="javascript:loadLeaveAvailableAddForm();"><strong>+</strong><b>Add Leave</b></a>
    <?php } ?>
    </h2>
...
<div class="sectionarea">    
    <h2 class="field_title"><?php echo $title_request; ?>
	<?php if($can_manage) { ?>
    	<a class="add_button" id="leave_request_add_button_wrapper" href="javascript:loadLeaveRequestAddForm();"><strong>+</strong><b>Add Leave Request</b></a>
    <?php } ?>
    </h2>
