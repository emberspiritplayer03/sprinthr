...
<div id="form_default">
  <table>
    ...
    <tr>
      ...
      <td><input class="validate[required,custom[number]] text-input" type="text" name="no_of_days_alloted" id="no_of_days_alloted" value="" /></td>
    </tr>
    <tr>
      <td class="field_label">Number of Days Available:</td>
      <td>
      <input type="text" class="validate[required,custom[number]] text-input" name="no_of_days_available" id="no_of_days_available" value="" /></td>
    </tr>
  </table>
</div><!-- #form_default -->
