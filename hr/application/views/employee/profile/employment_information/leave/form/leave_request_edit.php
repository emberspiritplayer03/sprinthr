...
<div id="form_default">
  <table>
  	 ...
  	 <tr>
  	   ...
  	   <td><select class="select_option" name="is_approved2" id="is_approved2">
  	     <?php if(strtolower($details->is_paid)=='yes') {
		  	$yes = 'selected="selected"'; 
		  }else if(strtolower($details->is_paid)=='no') {
       ...
       <?php if(strtolower($details->is_approved)=='pending') {
		  	$pending = 'selected="selected"'; 
		  }else if(strtolower($details->is_approved)=='approved') {
			$approved = 'selected="selected"';
		  }else if(strtolower($details->is_approved)=='disapproved') {
			$disapproved = 'selected="selected"';
			} ?>

  	     <option <?php echo $pending; ?> value="Pending">Pending</option>
  	     <option <?php echo $approved; ?> value="Approved">Approved</option>
  	     <option <?php echo $disapproved; ?> value="Disapproved">Disapproved</option>
	     </select></td>
    </tr>
  </table>
</div><!-- #form_default -->
