<script>
$("#edit_training_from").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
$("#edit_training_to").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
$("#edit_renewal_date").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
...
<div id="form_default">
  <table>
    ...
    <tr>
      ...
      <td><input class="text-input" type="text" name="from_date" id="edit_training_from" value="<?php echo $details->from_date; ?>" /></td>
    </tr>
    <tr>
      <td class="field_label">To:</td>
      <td>
      <input class="text-input" type="text" name="to_date" id="edit_training_to" value="<?php echo  ucfirst($details->to_date); ?>" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" class="validate[required] text-input" name="renewal_date" id="edit_renewal_date" value="<?php echo $details->renewal_date; ?>" /></td>
    </tr>
     -->
  </table>
</div><!-- #form_default -->
