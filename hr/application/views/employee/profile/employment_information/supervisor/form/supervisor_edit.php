...
<div class="form_action_section" id="form_default">
    <table>
    	<tr>
            ...
            <td><button class="btn btn-danger btn-small" type="button" name="button" id="button" onclick="javascript:loadSupervisorDeleteDialog('<?php echo $details->id; ?>')"><i class="icon-trash icon-white"></i> Delete Supervisor</button>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="javascript:loadSupervisorTable();">Cancel</a></td>
    	</tr>
    </table>
