...
<div class="form_action_section" id="form_default">
    <table>
    	<tr>
            ...
            <td><button class="btn btn-danger btn-small" type="button" onclick="javascript:loadSubordinatesDeleteDialog('<?php echo $supervisor->id; ?>')" name="button" id="button"><i class="icon-trash icon-white"></i> Delete Subordinate</button>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="javascript:loadSupervisorTable();">Cancel</a></td>
    	</tr>
    </table>
