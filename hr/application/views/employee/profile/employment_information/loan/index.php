...
<h2 class="field_title"><?php echo $title_deduction_available; ?><!--<a class="add_button" id="leave_available_add_button_wrapper" href="javascript:loadLeaveAvailableAddForm();"><strong>+</strong><b>Add Deduction</b></a>--></h2>
...
<script>
	$(function() { load_loan_list_dt("<?php echo $employee_id; ?>"); });
</script>
