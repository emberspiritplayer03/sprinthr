<div class="sectionarea">
    <h2 class="field_title"><?php echo $title_duration; ?>
    <?php echo $btn_add_duration; ?>
   	</h2>
           ...
           foreach($durations as $key=>$e) { ?>
            <tr>
              ...
              <?php if($permission_action == Sprint_Modules::PERMISSION_02) { ?>
              	<a href="javascript:void(0);" onclick="javascript:loadDurationEditForm('<?php echo $e->id; ?>');"><?php echo Date::convertDateIntIntoDateString($e->start_date); ?></a>
              <?php } else {echo Date::convertDateIntIntoDateString($e->start_date);} ?>
              </td>
              ...
              <td><?php if($e->attachment) { ?>
                <a class="blue_button small_button" target="_blank"  href="<?php echo FILES_FOLDER.$e->attachment; ?>"><i class="icon-file icon-white"></i> <?php echo $e->attachment; ?></a>
                <?php } ?>
  &nbsp; </td>
            </tr>
           <?php 
