...
select: function( event, ui ) {
			...
			window.location = base_url+"employee/profile?eid="+ui.item.id+"&hash="+ui.item.hash+"#personal_details";
			return false;
		}
});
});
...
<div id="project_site_history_wrapper" class="section_container"></div>
<div id="benefits_wrapper"></div>
