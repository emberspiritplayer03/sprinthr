...
<form method="post" name="edit_evaluation_form" id="edit_evaluation_form" action="<?php echo url('evaluation/edit_employee_evaluation');?>" enctype="multipart/form-data">	
...
<div id="form_main" class="inner_form popup_form">
	<div id="form_default">
        ...
        <tr>
         ...
         <td> <input class="validate[required]" type="text" name="evaldate" id="evaldate" value="<?php echo $eval->getEvaluationDate(); ?> " /> </td>
        </tr>
         <tr>
         <td><label>Score:</label></td>
         <td> <input class="validate[required]" type="number" step=".01" name="score" id="score" value="<?php echo $eval->getScore(); ?>" /> </td>
        </tr>
         <tr>
         <td><label>Next Evaluation Date:</label></td>
         <td> <input class="validate[required]" type="text" name="nextevaldate" id="nextevaldate" value="<?php echo $eval->getNextEvaluationDate(); ?>" /> </td>
        </tr>  
