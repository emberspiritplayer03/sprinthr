...
<div id="form_main" class="inner_form popup_form">
    ...
    <table width="100%"> 
        <tr>
            ...
            <td><input type="text" value="" name="branch_name" class="validate[required] text-input text" id="branch_name" /></td>
        </tr>    
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" value="" name="province" class="validate[required] text-input text" id="province" /></td>
        </tr>
         <tr>
            <td class="field_label">City</td>
            <td><input type="text" value="" name="city" class="validate[required] text-input text" id="city" /></td>
        </tr>    
         <tr>
            <td class="field_label">Address</td>
            <td><input type="text" value="" name="address" class="validate[required] text-input text" id="address" /></td>
        </tr>
         <tr>
            <td class="field_label">Zip Code</td>
            <td><input type="text" value="" name="zip_code" class="validate[required] text-input text" id="zip_code" /></td>
        </tr>
        <tr>
            <td class="field_label">Phone</td>
            <td><input type="text" value="" name="phone" class="validate[required] text-input text" id="phone" /></td>
        </tr>
        <tr>
            <td class="field_label">Fax</td>
            <td><input type="text" value="" name="fax" class="validate[required] text-input text" id="fax" /></td>
        </tr>     
    </table>
    </div><!-- #form_default -->
