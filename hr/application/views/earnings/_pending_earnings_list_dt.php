        ...
        <td valign="middle">
            <div class="i_container">
            	<ul class="dt_icons">
                	...
                	<li>
                    	<a title="Edit" id="tipsy" class="ui-icon ui-icon-pencil g_icon" href="javascript:void(0);" onclick="javascript:editEarning('<?php echo Utilities::encrypt($ea->getId()); ?>');"></a>
                    </li>
                    <li>
                    	<a title="Approve (Include to payroll)" id="tipsy" class="ui-icon ui-icon-check  g_icon" href="javascript:void(0);" onclick="javascript:approveEarning('<?php echo Utilities::encrypt($ea->getId()); ?>','<?php echo Utilities::encrypt($pid); ?>');"></a>
                    </li>                    
                    <li>
                    	<a title="Send to Archive" id="tipsy" class="ui-icon ui-icon-trash g_icon" href="javascript:void(0);" onclick="javascript:archivePendingEarning('<?php echo Utilities::encrypt($ea->getId()); ?>','<?php echo Utilities::encrypt($pid); ?>');"></a>
                    </li>
                </ul>
            </div>
         </td> 
