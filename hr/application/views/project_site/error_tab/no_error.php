...
<script>
    $(function() {
        ...
        load_no_error_logs_dt('<?php echo $from; ?>', '<?php echo $to; ?>');
        //$("table").tablesorter();
...
<div id="">
    ...
    <div class="dt_top_nav">
        ...
        <div class="dt_limit">Limit :
            <select id="dt_limit_no_error" style="width:50px;" onchange="javascript:load_attendance_logs_list_dt();">
