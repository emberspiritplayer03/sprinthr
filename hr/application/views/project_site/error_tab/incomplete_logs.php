...
<script>
    $(function() {
        ...
        load_incomplete_logs_dt('<?php echo $from; ?>', '<?php echo $to; ?>');
        //$("table").tablesorter();
        ...
        var emp_selected = new $.TextboxList('#emp_selected_incomplete', {
            unique: true,
            plugins: {
                autocomplete: {
                    minLength: 1,
...
<div id="">
    <div id="employee_search_container" style="overflow:visible !important; padding-bottom:15px;">
        <div class="employee_basic_search searchcnt" id="search_wrapper">
            ...
            <div class="float-left">
                ...
                <div id="all_emp_incomplete" class="float-left" style="width:312px;">
                    <input disabled="disabled" type="text" name="input_disabled" id="input_disabled" style="width:290px; min-width:290px;" value="" />
                </div>
                <div id="autocomplete_incomplete" class="float-left">
                    <input type="text" name="emp_selected" id="emp_selected_incomplete" />
                </div>
                <div class="clear"></div>
                <span class="float-left" style=" width:50px;">&nbsp;</span>
                <div class="float-left"><label><input checked="checked" type="checkbox" class="chk_employee" id="chk_employee" name="chk_employee" onclick="javascript:chkEmployeeIncomplete(this);" />All employees</label></div>
                <div class="clear"></div>
            </div>
    ...
    <div>
        <table id="" class="formtable">
            ...
            <tbody id="incomplete_logs_wrapper">
            </tbody>
        </table>
    </div>
</div>
