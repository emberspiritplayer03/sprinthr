        ...
        <div id="form_default">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select name="a_project_site_out" id="a_type">
                            <?php foreach ($project_sites as $project_site) { ?>
                                <option value="<?php echo $project_site->id; ?>" <?php echo (strtoupper($project_out) == strtoupper($project_site->id) ? 'selected="selected"' : ""); ?>><?php echo strtoupper($project_site->projectname); ?></option>
                            <?php } ?>
                        </select>
                    </td>
                </tr>
