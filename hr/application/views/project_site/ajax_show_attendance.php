...
<div align="right" class="float-right"><a class="blue_button" href="<?php echo url('project_site/download_timesheet_breakdown_by_employee_and_period?employee_id='. $encrypted_employee_id .'&from='. $start_date .'&to='. $end_date);?>"><i class="icon-download-alt icon-white"></i> Download Timesheet</a> 
