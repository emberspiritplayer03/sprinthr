...
<?php
    $path = 'application/views/project_site/_helper.php';
    include $path;
?>
...
<div class="btn-group" style="position:absolute;left:793px;top:71px;z-index:9999;">
    ...
    <ul class="dropdown-menu " style="margin-top:4px;margin-left:4px;">
        <li><a href="<?php echo url('project_site/download_timesheet_breakdown_by_employee_and_period?employee_id='. $encrypted_employee_id .'&from='. $start_date .'&to='. $end_date . '&report=detailed');?>">Detailed </a></li>
        <li><a href="<?php echo url('project_site/download_timesheet_breakdown_by_employee_and_period?employee_id='. $encrypted_employee_id .'&from='. $start_date .'&to='. $end_date . '&report=summarized');?>">Summarized </a></li>
    </ul>
</div>
...
<div class="container_12 npbutton_container">
    ...
    <div class="col_1_2 nextprevious_record nprecord_standalone" align="center">
        ...
        <form id="frm-employee-timesheet" method="get" action="<?php echo url('project_site/show_attendance'); ?>">  
