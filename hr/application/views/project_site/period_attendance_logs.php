...
?>
  <tr>
    <td class="payslip_period"><strong><a href="<?php echo url('project_site/attendance_logs_period?from='. $period['start'] .'&to='. $period['end'] . '&hpid=' . Utilities::encrypt($period['id']));?>"><?php echo Tools::getGmtDate('M j', strtotime($period['start']));?> - <?php echo Tools::getGmtDate('M j', strtotime($period['end']));?></a></strong></td>
    ...
    <!--<td><div id="dropholder"><a class="dropbutton" href="<?php echo url('project_site/attendance_logs_period?from='. $period['start'] .'&to='. $period['end']);?>">Download Timesheet</a></div></td>-->
    <td class="vertical-middle"><div id="dropholder"><a class="dropbutton" href="<?php echo url('project_site/attendance_logs_period?from='. $period['start'] .'&to='. $period['end'] . '&hpid=' . Utilities::encrypt($period['id']));?>"><i class="icon-zoom-in icon-fade"></i> View List</a></div>
    </td>
