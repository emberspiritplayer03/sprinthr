<form onsubmit="return checkForm()" method="post" id="edit_actual_time_form" action="<?php echo $action;?>">
    ...
    <div id="form_default" class="form_action_section">
      <table class="no_border" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="67%"><input value="Save" id="edit_actual_time_form_submit" class="curve blue_button" type="submit">&nbsp;<a href="javascript:void(0);" onclick="closeTheDialog()">Cancel</a></td>
          </tr>
        </table>		
    </div>
</div>
...
<script type="text/javascript">
	...
	$('#edit_actual_time_form #schedule_time_in').timepicker({
		'minTime': '8:00 am',
		'maxTime': '7:30 am',
		'timeFormat': 'g:i a'
	});
	$('#edit_actual_time_form #schedule_time_out').timepicker({
		'minTime': '8:00 am',
		'maxTime': '7:30 am',
		'timeFormat': 'g:i a'
	});	
	...
	function checkForm() {
		var time_in = $('#edit_actual_time_form #schedule_time_in').val();
		var time_out = $('#edit_actual_time_form #schedule_time_out').val();
		var date = $('#edit_actual_time_form #schedule_date').val();
