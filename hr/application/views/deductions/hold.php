...
<script>
    ...
    $(function(){
        $("#payslip-report-year-selector").change(function(){   
           changePayPeriodByYear(this.value,'<?php echo $cutoff_selected; ?>','payslip-pay-period-container');
        });
        ...
        changePayPeriodByYear($("#payslip-report-year-selector").val(),'<?php echo $cutoff_selected; ?>','payslip-pay-period-container');
    });  
</script>
...
<div class="break-bottom inner_top_option">   
    ...
    <br />-->
    <div id="hold_deductions_list_dt_wrapper" class="dtContainer"></div>    
</form>
<script>
	$(function() { 
		load_hold_deductions_list_dt("<?php echo $eid; ?>","<?php echo $period['from']; ?>","<?php echo $period['to']; ?>");
