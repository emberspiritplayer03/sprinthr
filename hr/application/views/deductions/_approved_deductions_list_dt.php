            ...
            <td valign="middle">
                <div class="i_container">
                	<ul class="dt_icons">
                        ...
                        <li>
                        	<a title="Send to Archive" id="tipsy" class="ui-icon ui-icon-trash g_icon" href="javascript:void(0);" onclick="javascript:archiveApprovedDeduction('<?php echo Utilities::encrypt($ea->getId()); ?>','<?php echo Utilities::encrypt($pid); ?>');"></a>
                        </li>
                    </ul>
                </div>
            </td> 
