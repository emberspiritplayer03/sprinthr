...
<table border=0 cellpadding=0 cellspacing=0 width=8220 style='border-collapse:
 ...
 <tr height=25 style='height:18.75pt'>
  ...
  Accounting Dept. - Payroll (Detailed Counter Check)</td>
  <td class=xl67></td>
  <td class=xl67></td>
  <td class=xl67></td>
  <td class=xl67></td>
  ...
  foreach ($grouped_data as $cost_center_key => $cost_center_data) { 
    ...
    foreach($cost_center_data as $cdata) {
      ...
      foreach($payslip_section_other_earnings as $psoe_key => $psoe) {
        if($psoe['label']!=="13th Month Bonus")
...
?>
 ...
 <tr height=86 style='height:64.5pt'>
  ...
  <td class=xl71 width=64 style='width:48pt'><!-- COST CENTER -->PROJECT SITE</td>
  <!-- <td class=xl71 width=64 style='width:48pt'>PAY STATUS</td> -->
  <td class=xl71 width=177 style='width:133pt'>EMPLOYEE NAME</td>
  ...
  <td class=xl71 width=72 style='width:57pt'>ABSENT</td>  
  ...
  <td class=xl90 width=64 style='width:48pt'>NET PAY</td>
  <!-- <td class=xl90 width=64 style='width:48pt'>ARAP CLEARING</td>
  <td class=xl90 width=64 style='width:48pt'>PAYROLL CLEARING</td> -->
  <td class=xl67></td>
  <td class=xl67></td>
  <td style="border-left: .5pt solid black;" class=xl90>Reg HRS</td>
  <td style="border-left: .5pt solid black;" class=xl90>Reg OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Reg NS Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Reg NS OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD NS Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD NS OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD Special Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD Special OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD Special NS Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD Special NS OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD Legal Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD Legal OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>RD Legal NS Hrs</td>

  <td style="border-left: .5pt solid black;" class=xl90>RD Legal NS OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Special Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Special OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Special NS Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Special NS OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Legal Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Legal OT Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Legal NS Hrs</td>
  <td style="border-left: .5pt solid black;" class=xl90>Legal NS OT Hrs</td>
...
<?php foreach ($grouped_data as $cost_center_key => $cost_center_data) { ?>
        ...
        <?php 
          ...
          foreach($obj_labels as $obj) {
            ...
            //echo $obj->getVariable(); echo '<hr />';
            
            if($obj->getVariable() == 'regular_hours') {
              $regular_hours += $obj->getValue();
            }            
            if($obj->getVariable() == 'regular_ot_hours') {
              $regular_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'regular_ns_hours') {
              $regular_ns_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'regular_ns_ot_hours') {
              $regular_ns_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_hours') {
              $restday_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_ot_hours') {
              $restday_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_ns_hours') {
              $restday_ns_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_ns_ot_hours') {
              $restday_ns_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_special_hours') {
              $restday_special_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_special_ot_hours') {
              $restday_special_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_special_ns_hours') {
              $restday_special_ns_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_special_ns_ot_hours') {
              $restday_special_ns_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_legal_hours') {
              $restday_legal_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_legal_ot_hours') {
              $restday_legal_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_legal_ns_hours') {
              $restday_legal_ns_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'restday_legal_ns_ot_hours') {
              $restday_legal_ns_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'holiday_special_hours') {
              $holiday_special_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'holiday_special_ot_hours') {
              $holiday_special_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'holiday_special_ns_hours') {
              $holiday_special_ns_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'holiday_special_ns_ot_hours') {
              $holiday_special_ns_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'holiday_legal_hours') {
              $holiday_legal_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'holiday_legal_ot_hours') {
              $holiday_legal_ot_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'holiday_legal_ns_hours') {
              $holiday_legal_ns_hours += $obj->getValue();
            }
            if($obj->getVariable() == 'holiday_legal_ns_ot_hours') {
              $holiday_legal_ns_ot_hours += $obj->getValue();
            }
          ...
          $sub_total['regular_hours'] += $regular_hours;
          $sub_total['regular_ot_hours'] += $regular_ot_hours;
          $sub_total['regular_ns_hours'] += $regular_ns_hours;
          $sub_total['regular_ns_ot_hours'] += $regular_ns_ot_hours;
          $sub_total['restday_hours']    += $restday_hours;
          $sub_total['restday_ot_hours'] += $restday_ot_hours;
          $sub_total['restday_ns_hours'] += $restday_ns_hours;
          $sub_total['restday_ns_ot_hours']   += $restday_ns_ot_hours;
          $sub_total['restday_special_hours'] += $restday_special_hours;
          $sub_total['restday_special_ot_hours'] += $restday_special_ot_hours;
          $sub_total['restday_special_ns_hours'] += $restday_special_ns_hours;
          $sub_total['restday_special_ns_ot_hours'] += $restday_special_ns_ot_hours;
          $sub_total['restday_legal_hours']    += $restday_legal_hours;
          $sub_total['restday_legal_ot_hours'] += $restday_legal_ot_hours;
          $sub_total['restday_legal_ns_hours'] += $restday_legal_ns_hours;
          $sub_total['restday_legal_ns_ot_hours'] += $restday_legal_ns_ot_hours;
          $sub_total['holiday_special_hours']     += $holiday_special_hours;
          $sub_total['holiday_special_ot_hours']  += $holiday_special_ot_hours;
          $sub_total['holiday_special_ns_hours']  += $holiday_special_ns_hours;
          $sub_total['holiday_special_ns_ot_hours'] += $holiday_special_ns_ot_hours;
          $sub_total['holiday_legal_hours']    += $holiday_legal_hours;
          $sub_total['holiday_legal_ot_hours'] += $holiday_legal_ot_hours;
          $sub_total['holiday_legal_ns_hours'] += $holiday_legal_ns_hours;
          $sub_total['holiday_legal_ns_ot_hours'] += $holiday_legal_ns_ot_hours;
        ...
        <tr height=20 style='height:15.0pt'>
          ...
          <td class=xl72 style='border-left:none'>&nbsp;<?php echo $cdata['hired_date']; ?></td>
          <td class=xl73>&nbsp;<?php echo $cdata['employment_status']; ?></td>
          <td class=xl73><?php echo $cdata['cost_center']; ?></td>
          <!-- <td class=xl73>&nbsp;<?php echo $salary_type; ?></td> -->
          ...
          <!-- <td class=xl74><?php echo number_format($employee_taxable_earnings,2, '.' , ',' ); ?></td>
          ...
          <td class=xl74><?php echo number_format($staff_benefits_deductions_other_adj,2, '.' , ',' ); ?></td>
          <td class=xl74><?php echo number_format($total_net_pay,2, '.' , ',' ); ?></td>
          <!-- <td class=xl74>-</td>
          <td class=xl74>-</td> -->
          <td class=xl67></td>
          <td class=xl67></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($regular_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($regular_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($regular_ns_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($regular_ns_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_ns_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_ns_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_special_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_special_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_special_ns_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_special_ns_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_legal_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_legal_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_legal_ns_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($restday_legal_ns_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($holiday_special_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($holiday_special_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($holiday_special_ns_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($holiday_special_ns_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($holiday_legal_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($holiday_legal_ot_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($holiday_legal_ns_hours,2, '.' , ',' ); ?></td>
          <td style="border-left: .5pt solid black;" class=xl74><?php echo number_format($holiday_legal_ns_ot_hours,2, '.' , ',' ); ?></td>
        </tr>

      <?php } ?>

        <tr height=20 style='height:15.0pt'>
          <td colspan=4 height=20 class=xl83 style='border-right:.5pt solid black; height:15.0pt'>&nbsp; <font class="font8">Total:</font></td>
          <td class=xl76>&nbsp;</td>
          <td class=xl75>&nbsp;</td>
          <td class=xl76>&nbsp;</td>
          <td class=xl76>&nbsp;</td>
          ...
          <td class=xl67></td>
          <td class=xl67></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['regular_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['regular_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['regular_ns_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['regular_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_ns_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_special_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_special_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_special_ns_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_special_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_legal_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_legal_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_legal_ns_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['restday_legal_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['holiday_special_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['holiday_special_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['holiday_special_ns_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['holiday_special_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['holiday_legal_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['holiday_legal_ot_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['holiday_legal_ns_hours'],2, '.' , ',' ); ?></strong></td>
          <td style="border-left: .5pt solid black;" class=xl77><strong><?php echo number_format($sub_total['holiday_legal_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
        </tr>
        ...
        <?php 
          ...
          $grand_total['regular_hours']    += $sub_total['regular_hours'];
          $grand_total['regular_ot_hours'] += $sub_total['regular_ot_hours'];
          $grand_total['regular_ns_hours'] += $sub_total['regular_ns_hours'];
          $grand_total['regular_ns_ot_hours'] += $sub_total['regular_ns_ot_hours'];
          $grand_total['restday_hours']    += $sub_total['restday_hours'];
          $grand_total['restday_ot_hours'] += $sub_total['restday_ot_hours'];
          $grand_total['restday_ns_hours'] += $sub_total['restday_ns_hours'];
          $grand_total['restday_ns_ot_hours']   += $sub_total['restday_ns_ot_hours'];
          $grand_total['restday_special_hours'] += $sub_total['restday_special_hours'];
          $grand_total['restday_special_ot_hours'] += $sub_total['restday_special_ot_hours'];
          $grand_total['restday_special_ns_hours'] += $sub_total['restday_special_ns_hours'];
          $grand_total['restday_special_ns_ot_hours'] += $sub_total['restday_special_ns_ot_hours'];
          $grand_total['restday_legal_hours']    += $sub_total['restday_legal_hours'];
          $grand_total['restday_legal_ot_hours'] += $sub_total['restday_legal_ot_hours'];
          $grand_total['restday_legal_ns_hours'] += $sub_total['restday_legal_ns_hours'];
          $grand_total['restday_legal_ns_ot_hours'] += $sub_total['restday_legal_ns_ot_hours'];
          $grand_total['holiday_special_hours']    += $sub_total['holiday_special_hours'];
          $grand_total['holiday_special_ot_hours'] += $sub_total['holiday_special_ot_hours'];
          $grand_total['holiday_special_ns_hours'] += $sub_total['holiday_special_ns_hours'];
          $grand_total['holiday_special_ns_ot_hours'] += $sub_total['holiday_special_ns_ot_hours'];
          $grand_total['holiday_legal_hours']    += $sub_total['holiday_legal_hours'];
          $grand_total['holiday_legal_ot_hours'] += $sub_total['holiday_legal_ot_hours'];
          $grand_total['holiday_legal_ns_hours'] += $sub_total['holiday_legal_ns_hours'];
          $grand_total['holiday_legal_ns_ot_hours'] += $sub_total['holiday_legal_ns_ot_hours'];
...
<tr height=20 style='height:15.0pt'>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl67></td>
  <td class=xl67></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['regular_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['regular_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['regular_ns_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['regular_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_ns_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_special_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_special_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_special_ns_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_special_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_legal_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_legal_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_legal_ns_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['restday_legal_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['holiday_special_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['holiday_special_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['holiday_special_ns_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['holiday_special_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['holiday_legal_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['holiday_legal_ot_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['holiday_legal_ns_hours'],2, '.' , ',' ); ?></strong></td>
  <td style="" class=xl78><strong><?php echo number_format($grand_total['holiday_legal_ns_ot_hours'],2, '.' , ',' ); ?></strong></td>
