...
<?php foreach ($grouped_data as $cost_center_key => $cost_center_data) { ?>
        ...
        <tr height=20 style='height:15.0pt'>
          ...
          <!-- <td class=xl74>&nbsp;<?php //echo number_format($emp_legal_holiday_amount,2, '.' , ',' ); ?></td> -->
          ...
          <!-- <td class=xl74>- &nbsp;</td>
          <td class=xl74><?php //echo number_format($earnings_benefits_seniority_total,2, '.' , ',' ); ?>&nbsp;</td>
          <td class=xl74><?php //echo number_format($earnings_benefits_transpo_total,2, '.' , ',' ); ?>&nbsp;</td>
          <td class=xl74><?php //echo number_format($earnings_benefits_meal_total,2, '.' , ',' ); ?>&nbsp;</td>
          <td class=xl74>-&nbsp;</td>
          <td class=xl74>-&nbsp;</td>
          <td class=xl74>-&nbsp;</td> -->
      ...
      <?php } ?>
        ...
        <tr height=20 style='height:15.0pt'>
          ...
          <!-- <td class=xl77>-&nbsp;</td>
          <td class=xl77><strong><?php //echo number_format($sub_total['seniority'],2, '.' , ',' ); ?></strong>&nbsp;</td>
          <td class=xl77><strong><?php //echo number_format($sub_total['transpo'],2, '.' , ',' ); ?></strong>&nbsp;</td>
          <td class=xl77><strong><?php //echo number_format($sub_total['meal'],2, '.' , ',' ); ?></strong>&nbsp;</td>
          <td class=xl77>-&nbsp;</td>
          <td class=xl77>-&nbsp;</td>
          <td class=xl77>-&nbsp;</td> -->
          <?php foreach($earnings_benefits_label_array as $ebla_key => $ebla) { ?>
...
<tr height=20 style='height:15.0pt'>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <!-- <td class=xl78>&nbsp;<strong><?php //echo number_format($grand_total['legal_holiday'],2, '.' , ',' ); ?></strong></td> -->
  <!-- 
  <td class=xl78>-</td>
  <td class=xl78>-</td>
  <td class=xl78>-</td>
  ...
  <!-- <td class=xl78>-&nbsp;</td>
  <td class=xl78><strong><?php //echo number_format($grand_total['seniority'],2, '.' , ',' ); ?></strong>&nbsp;</td>
  <td class=xl78><strong><?php //echo number_format($grand_total['transpo'],2, '.' , ',' ); ?></strong>&nbsp;</td>
  <td class=xl78><strong><?php //echo number_format($grand_total['meal'],2, '.' , ',' ); ?></strong>&nbsp;</td>
  <td class=xl78>-&nbsp;</td>
  <td class=xl78>-&nbsp;</td>
  <td class=xl78>-&nbsp;</td> -->
  <?php foreach($earnings_benefits_label_array as $ebla_key => $ebla) { ?>
