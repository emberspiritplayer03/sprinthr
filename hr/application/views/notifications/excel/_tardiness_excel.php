...
<div style="width:80%">   
	...
	<table border="1" cellpadding="2" cellspacing="1" style="font-size:9pt; width:536pt; line-height:12pt;">
		<tr>
	        ...
	        <td align="center" valign="top" style="border-bottom:none;"><strong>Hours Late</span></strong></td>
	    </tr>
		<?php 
		...
		?>
	    	<tr>
	            ...
	            <td align="left" valign="top" style="border-bottom:none;"><?php echo $value['late_hours']; ?></td>
	        </tr>
	    <?php } ?>
