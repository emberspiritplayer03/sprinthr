                    ...
                    <tr class="hover-link">
                      ...
                      <td style="text-align:center" >
                          <div class="overlay" style="height: 10px; display: none;">
                              <a href="<?php echo url('notifications/view_notification?eid='.Utilities::encrypt($a['id']).'&hash='.Utilities::createHash($a['id']));?>" style="padding:0px 7px 0px 5px" class="btn btn-edit-type" ><i class="icon-search"> </i> View Details</a>
                          </div>
                      </td>
                    </tr>
                <?php } ?>
