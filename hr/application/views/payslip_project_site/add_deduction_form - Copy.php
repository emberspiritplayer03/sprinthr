...
<input type="hidden" name="to" value="<?php echo $to;?>" />
  ...
  <table width="320" border="0" cellpadding="5" cellspacing="1">
    ...
    <tr>
      <td width="51">Name</td>
      <td width="246"><div id="name-handler"><input id="deduction_name" name="label" type="text" /></div></td>
    </tr>
    <tr>
      <td>Amount</td>
...
<!--<input id="deduction_name" name="label" type="text" />-->
...
<script>
var default_value = $('#text-name').html();
