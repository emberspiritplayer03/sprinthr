...
<script>
  $(function() {
    ...
    $('.jump-to-cutoff').click(function() {
      ...
      location.href = base_url + 'payslip_project_site/manage?from=' + arr_cp[0] + '&to=' + arr_cp[1];
    });
    ...
    <tbody>
      <?php foreach ($employees as $e) : ?>
        <tr>
          ...
          <td>
            <a class="dropbutton" title="Edit Payslip" href="<?php echo url('payslip_project_site/show_payslip?employee_id=' . Utilities::encrypt($e->getId()) . '&hash=' . $e->getHash() . '&from=' . $from . '&to=' . $to . '&frequency=' . $frequency); ?>"><?php echo $e->getLastname(); ?> <?php echo $e->extension_name; ?> , <?php echo $e->getFirstname(); ?> <?php echo $e->middlename[0]; ?>. </a>
            <!--<a href="<?php echo url('payslip_project_site/show_payslip?employee_id=' . Utilities::encrypt($e->getId()) . '&hash=' . $e->getHash() . '&from=' . $start_date . '&to=' . $end_date); ?>"><?php echo $e->getLastname(); ?>  <?php echo $e->extension_name; ?> , <?php echo $e->getFirstname(); ?> <?php echo $e->middlename[0]; ?>. </a>-->
          </td>
          <!--          <td>3</td>
          <td>5</td>
          <td>8</td>
