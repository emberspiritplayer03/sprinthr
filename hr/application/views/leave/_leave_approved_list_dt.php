		...
		var to		= $('#to_period').val();
		  var oTable = $('#approved_leave_list').dataTable({   
		   "aoColumns": [	
			...
			"bPaginate": true,			
			'sAjaxSource': base_url + 'leave/_load_server_approved_leave_list_dt?dept_id=<?php echo Utilities::encrypt($dept_id); ?>&from=<?php echo $from_date; ?>&to=<?php echo $to_date; ?>&frequency_id=<?php echo $frequency_id; ?>',
