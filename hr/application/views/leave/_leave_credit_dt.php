<script>
	$(function() {		
		  var oTable = $('#leave_credit_dt').dataTable({   
		   "aoColumns": [
			...
			'sAjaxSource': base_url + 'leave/_load_server_leave_credit_employee_list_dt?dept_id=<?php echo Utilities::encrypt($dept_id); ?>',
...
<table id="leave_credit_dt" class="display">
    <thead>
      <tr>
