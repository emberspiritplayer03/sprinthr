...
<script>
$(function(){
  $("#leave_request_approvers").validationEngine({scroll:false});
  $("#leave_request_approvers").ajaxForm({
    success:function(o) {        
...
<form id="leave_request_approvers" name="leave_request_approvers"  action="<?php echo url('leave/_update_leave_request_approvers'); ?>" method="post" > 
