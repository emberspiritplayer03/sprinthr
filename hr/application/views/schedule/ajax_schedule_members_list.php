        ...
        <?php foreach ($groups as $g):?>
          ...
          <td style="border-bottom:1px solid #cccccc">
              <?php if($permission_action == Sprint_Modules::PERMISSION_02) { ?>
                <a class="" href="javascript:void(0)" onclick="javascript:removeScheduleMember(<?php echo $g->getId();?>, '<?php echo $schedule_id;?>', 'group')" style="float:right;" title="Remove"><i class="icon-remove"><span class="tooltip" title="Remove"></span></i></a>
              <?php } ?>
              <?php echo $g->getName();?>
          </td>
          </tr>
    ...
    <table width="100%" class="formtable">
      <thead>
        ...
        <tr id="<?php echo $e->getId();?>-<?php echo $schedule_id;?>-employee">
          <td style="border-bottom:1px solid #cccccc">
            <?php if($permission_action == Sprint_Modules::PERMISSION_02) { ?>
              <a class="" href="javascript:void(0)" onclick="javascript:removeScheduleMember(<?php echo $e->getId();?>, '<?php echo $schedule_id;?>', 'employee')" style="float:right;" title="Remove"><i class="icon-remove"><span class="tooltip" title="Remove"></span></i></a>
            <?php } ?>
