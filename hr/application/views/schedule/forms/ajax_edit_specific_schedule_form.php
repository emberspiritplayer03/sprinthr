	...
	<div id="form_default" align="center">
	  <table class="no_border" width="100%">
	    ...
	    <tr>
	      ...
	      to
          <input style="width:55px" type="text" name="schedule_time_out" id="schedule_time_out" value="<?php echo $time_out;?>" /></td>
        </tr>
	    <tr>
...
<script type="text/javascript">
	...
	$("#edit_specific_schedule_form #schedule_date").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
	$("#edit_specific_schedule_form #schedule_end_date").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
