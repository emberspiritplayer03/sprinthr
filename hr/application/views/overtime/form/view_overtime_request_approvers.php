...
<script>
$(function(){
  $("#overtime_request_approvers").validationEngine({scroll:false});
  $("#overtime_request_approvers").ajaxForm({
    success:function(o) {        
...
<form id="overtime_request_approvers" name="overtime_request_approvers"  action="<?php echo url('overtime/_update_overtime_request_approvers'); ?>" method="post" > 
