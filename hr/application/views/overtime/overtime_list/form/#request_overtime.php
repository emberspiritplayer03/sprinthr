...
<form id="request_overtime_hideshow_form" name="request_overtime_hideshow_form" autocomplete="off" method="POST" action="<?php echo url('overtime/insert_employee_request_overtime_hideshow'); ?>">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="2">
          <tr>
            ...
            <td style="width:85%" align="left" valign="middle">
                <input type="text" style="width:150px;" id="start_date_hideshow" name="start_date_hideshow" class="validate[required]" readonly="readonly" />
            </td>
          </tr>
          <tr>
            <td style="width:15%" align="left" valign="middle">Time :</td>
            <td style="width:85%" align="left" valign="middle">
                <input type="text" style="width:70px;" id="start_time_hideshow" name="start_time_hideshow" class="" onchange="javascript:onStartTimeChanged();" placeholder="Starts on" />
                <input type="text" style="width:70px;" id="end_time_hideshow" name="end_time_hideshow" class="" placeholder="Ends on" />
            </td>
          </tr>
          <tr>
