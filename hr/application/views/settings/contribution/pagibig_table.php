<script>
$(function(){
    $(".pagibig-import-btn").click(function(){
        importPagibigTable();
    });

    var oTable = $('#dtPagibig').dataTable( {
       "aoColumns": [               
...
<!--
<a onclick="javascript:void(0);" class="pagibig-import-btn gray_button float-right" id="" href="javascript:void(0);"><i class="icon-excel icon-custom"></i> Import Pagibig Table </a> -->
<br />
<div class="table-container">
<input type="hidden" id="pagibig_type" value="pagibig" />
<table id="dtPagibig" class="display">
<thead>
  <tr>
    <th valign="top"></th> 
