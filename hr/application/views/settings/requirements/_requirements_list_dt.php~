...
$(function() {
	  ...
	  var oTable = $('#requirements').dataTable({   
	   "aoColumns": [		   		
				...
				{sWidth: '85%',sClass:'dt_small_font'}					
		 ],
		'bProcessing':true,
		'bServerSide':true,
		"bAutoWidth": true,
		...
		"bPaginate": true,
		'sAjaxSource': base_url + 'settings/_load_server_requirements_list_dt',
...
<div class="btn-group pull-right">
    ...
    <ul class="dropdown-menu">		    
	    <li><a onclick="javascript:requirements_with_selected_confirmation('archive');" href="javascript:void(0);"><i class="icon-trash"></i> Archive</a></li>
    </ul>
</div>
<div class="clear"></div>
<br />
