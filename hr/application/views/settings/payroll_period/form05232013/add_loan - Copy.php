...
$(document).ready(function() {	
	...
	$("#start_date").datepicker({
		...
		onSelect	:function() { 
			...
			var output = computeDays($("#start_date").val(),$("#end_date").val());					
...
<div id="formwrap">	
	<h3 class="form_sectiontitle">Add New Loan</h3>
<div id="form_main">     
    ...
    <div id="form_default">      
        <table>
             ...
             <tr>
               ...
               <td>
               		...
               		<?php foreach($deduction_type as $dt){ ?>
                    	<option value="<?php echo Utilities::encrypt($dt->getId()); ?>" selected="selected"><?php echo $dt->getDeductionType(); ?></option>
                    <?php } ?>
                    </select>
               </td>
             </tr>   
             <tr>
               ...
               <td>
               		<input style="width:35px;margin-right:6px;" class="validate[required,custom[integer]] text-input" type="text" name="no_of_installment" id="no_of_installment" value="" />
               </td>
             </tr>   
             <tr>
               <td class="field_label">Start Date:</td>
               <td>
               		<input class="validate[required] text-input" type="text" name="start_date" id="start_date" value="" />
               </td>
             </tr>
             <tr>
               <td class="field_label">End Date:</td>
               <td>
               		<input class="validate[required] text-input" type="text" name="end_date" id="end_date" value="" />
               </td>
             </tr>
             <tr>
