...
<form id="edit_loan" name="edit_loan" onsubmit="javascript:checkForm();"  action="<?php echo url('loan/_insert_new_loan'); ?>" method="post"> 
        ...
        <table>
             ...
             <tr>
               ...
               <td>
               		...
               		<input style="width:35px;height:18px;" class="validate[required,custom[integer]] input-mini" type="text" name="interest_rate" id="interest_rate" value="<?php echo $gel->getInterestRate(); ?>" /><span class="add-on">%</span>
                    </div>
               </td>
             </tr>
             <tr>
               ...
               <td>
                   <div class="input-append">
                        <input style="width:254px;height:18px;z-index:9999;" class="validate[required,custom[money]]" type="text" name="loan_amount" id="loan_amount" value="<?php echo number_format($gel->getLoanAmount(),2,".",","); ?>" />					
             ...
             <tr>
               ...
               <td>
               		<select class="validate[required] select_option" name="type_of_deduction_id" id="type_of_deduction_id">        
             ...
             <tr>
               ...
               <td>
               		<input style="width:35px;margin-right:6px;" class="validate[required,custom[integer]] text-input" type="text" name="no_of_installment" id="no_of_installment" value="<?php echo $gel->getNoOfInstallment(); ?>" />
               </td>
             </tr>   
             <tr>
               <td class="field_label">Start Date:</td>
               <td>
               		<input class="validate[required] text-input" type="text" name="start_date" id="edit_start_date" value="<?php echo $gel->getStartDate(); ?>" />
               </td>
             </tr>
             <tr>
               <td class="field_label">End Date:</td>
               <td>
               		<input class="validate[required] text-input" type="text" name="end_date" id="edit_end_date" value="<?php echo $gel->getEndDate(); ?>" />
               </td>
             </tr>
             <tr>
