    ...
    <div id="form_default">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left" valign="top"><select name="job_id" class="validate[required] text select_option_sched" id="job_id">
          ...
          <tr>
            ...
            <td align="left" valign="top"><input type="text" value="" name="created_by" class="validate[required] text" id="created_by" /></td>
          </tr>
        </table>    
    </div>
