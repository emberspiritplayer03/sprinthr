    ...
    <div id="form_default" class="form_action_section">
        <table width="100%">
            <tr>
                ...
                <td><a href="javascript:void(0);" onclick="javascript:archivePerformanceTemplate('<?php echo Utilities::encrypt($details->id); ?>');" class="delete_link red float-right"><span class="delete"></span>Delete Performance</a><a onclick="javascript:loadPerformanceDetailsForm();" class="edit_button" href="#performance_details_table_wrapper"><strong></strong>Edit Details</a></td>
            </tr>
        </table>
    </div>
</div>
