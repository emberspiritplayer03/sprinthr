...
<input type="hidden" name="company_benefits_with_selected_action" id="company_benefits_with_selected_action" value="" />
<div class="break-bottom inner_top_option">        
    <a id="request_leave_button" class="gray_button" href="javascript:addCompanyBenefit();"><i class="icon-plus"></i> <b>Add Company Benefits</b></a>
    <div class="pull-right">
    	<a title="View All" id="btn_viewall" class="btn btn-small active" href="javascript:load_company_benefits_list_dt();">&nbsp;&nbsp;<i class="icon-th-list"></i>&nbsp;&nbsp;</a>
      <a title="View Archives" id="btn_viewallarchives" class="btn btn-small" href="javascript:load_archive_company_benefits_list_dt();">&nbsp;&nbsp;<i class="icon-trash"></i>&nbsp;&nbsp;</a>
    </div>
    <div class="clear"></div>
</div>    	  
    <div id="company_benefits_dt_wrapper" class="dtContainer"></div>    
</form>
