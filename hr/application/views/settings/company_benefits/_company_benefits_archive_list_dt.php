...
$(function() {
	  ...
	  var oTable = $('#requirements').dataTable({   
	   "aoColumns": [		   		
		...
		"bPaginate": true,
		'sAjaxSource': base_url + 'settings/_load_server_archive_company_benefits_list_dt',
...
<div class="btn-group pull-right">
    ...
    <ul class="dropdown-menu">		    
	    <li><a onclick="javascript:company_benefits_with_selected_confirmation('restore');" href="javascript:void(0);"><i class="icon-trash"></i> Restore</a></li>
    </ul>
</div>
<div class="clear"></div>
<br />
