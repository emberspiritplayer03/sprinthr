...
$(function() {
	  ...
	  var oTable = $('#payroll_period_list').dataTable({   
	   "aoColumns": [
		...
		"bPaginate": true,			
		'sAjaxSource': base_url + 'settings/_load_server_memo_template_list_dt',
...
<div class="btn-group pull-right">
    ...
    <ul class="dropdown-menu">		    
	    <li><a onclick="javascript:memo_with_selected_confirmation('archive');" href="javascript:void(0);"><i class="icon-trash"></i> Archive</a></li>
    </ul>
</div>
<div class="clear"></div>
<br />
