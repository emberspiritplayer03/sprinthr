...
<div id="form_default">    
    ...
    <table width="50%" border="0" cellpadding="3" cellspacing="0"> 
        <tr>
            <td width="30%" valign="top" class="field_label">SSS Number:</td>
            <td width="70%" valign="top"> <?php echo($ci ? $ci->getSssNumber() : 'Undefined'); ?></td>
        </tr>
        <tr>
            <td width="30%" valign="top" class="field_label">Philhealth Number:</td>
            <td width="70%" valign="top">
                <?php echo($ci ? $ci->getPhilhealthNumber() : 'Undefined'); ?>        
            </td>
        </tr>    
        <tr>
            <td width="30%" valign="top" class="field_label">Pagibig Number:</td>
            <td width="70%" valign="top">
                <?php echo($ci ? $ci->getPagibigNumber() : 'Undefined'); ?>        
            </td>
        </tr>    
        <tr>
            <td width="30%" valign="top" class="field_label">TIN:</td>
            <td width="70%" valign="top">
                <?php echo($ci ? $ci->getTinNumber() : 'Undefined'); ?>        
            </td>
        </tr>    
    </table>
</div>
