<div id="form_main" class="inner_form popup_form">
	<form name="editGroupTeam" id="editGroupTeam" method="post" action="<?php echo url('settings/add_group_team'); ?>">    
    ...
    <table width="100%"> 
        <tr>
         ...
         <tr>
            <td class="field_label">Group / Team:</td>
            <td>
                <select id="type" name="type">
                	<option <?php echo($d->getType() == G_Company_Structure::GROUP ? 'selected="selected"' : ''); ?> value="<?php echo G_Company_Structure::GROUP; ?>"><?php echo G_Company_Structure::GROUP; ?></option>
                    <option <?php echo($d->getType() == G_Company_Structure::TEAM ? 'selected="selected"' : ''); ?> value="<?php echo G_Company_Structure::TEAM; ?>"><?php echo G_Company_Structure::TEAM; ?></option>
                </select>
            </td>
        </tr>
        <tr>
