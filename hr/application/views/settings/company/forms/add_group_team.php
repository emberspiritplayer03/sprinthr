<div id="form_main" class="inner_form popup_form">
	<form name="addGroupTeam" id="addGroupTeam" method="post" action="<?php echo url('settings/add_group_team'); ?>">    
         ...
         <tr>
            ...
            <td>
                <select id="type" name="type">
                	<option value="<?php echo G_Company_Structure::GROUP; ?>"><?php echo G_Company_Structure::GROUP; ?></option>
                    <option value="<?php echo G_Company_Structure::TEAM; ?>"><?php echo G_Company_Structure::TEAM; ?></option>
                </select>
            </td>
        </tr>
        <tr>
