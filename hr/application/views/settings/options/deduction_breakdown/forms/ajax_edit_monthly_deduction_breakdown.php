...
<form id="edit_monthly_deduction_breakdown_form" method="post" action="<?php echo url('settings/_update_monthly_deduction_breakdown');?>">
      ...
      <tr>
        ...
        <td>
        	<div class="input-append">
        		<input type="text" class="validate[required]" onchange="javascript:getPercentage(1);" id="1st_cutoff" name="1st_cutoff" style="width:15%" value="<?php echo $b[0]; ?>" readonly="readonly" />
        		<span class="add-on">%</span> <small class="red">(Cut-off)</small>
        	</div>        	
        	<div class="input-append">
        		<input type="hidden" class="validate[required]" onchange="javascript:getPercentage(2);" id="2nd_cutoff" name="2nd_cutoff" style="width:15%" value="<?php echo $b[1]; ?>" />
