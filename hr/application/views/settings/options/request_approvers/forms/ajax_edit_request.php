...
<form method="post" id="edit_request" name="edit_request" action="<?php echo url($action);?>">
<input type="hidden" id="token" name="token" value="<?php echo $token; ?>" />
<input type="hidden" id="req_id" name="req_id" value="<?php echo Utilities::encrypt($gsr->getId()); ?>" />
        ...
        <table width="100%">
          <tr>
            <td>
             ...
             <td>
               <input class="validate[required] text-input text" type="text" value="<?php echo $gsr->getTitle(); ?>" name="title" id="title" />
            </td>
          </tr>
          <tr>
            <td>
