...
<div id="form_main" class="inner_form popup_form">
	<form name="skillManagement" id="skillManagement" method="post" action="<?php echo url("settings/add_skill"); ?>">
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="0"> 
        <tr>
            ...
            <td>
                <input type="text" value="" name="skill" class="validate[required] text" id="skill" />    
            </td>
        </tr>       
    </table>
    </div>
