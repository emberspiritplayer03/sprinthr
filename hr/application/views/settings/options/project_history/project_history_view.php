...
<div class="break-bottom inner_top_option">        
    <a id="request_leave_button" class="gray_button" href="javascript:addProjectType();"><i class="icon-plus"></i> <b>Add Project Site</b></a>
  <!--   <div class="pull-right">
    ...
    <div id="project_site_list_dt_wrapper" class="dtContainer"></div>    
</form>
<div id="dialog-confirm" style="display:none;">
      <div class="confirmation-box"><div>Are you sure you want to delete?</div></div>
</div>
 <div id="dialog-confirm-delete" style="display:none;">
      <div><div>Project Site Successfully Deleted "</div></div>
</div>
