...
function checkForm() {
  ...
  var total_checked = $('#update_account_form input[type="checkbox"]:checked').length;
...
<form id="update_account_form" onsubmit="return checkForm()"  action="<?php echo url('settings/update_account'); ?>" method="post"  name="employee_account_form" >
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="left" valign="top">          
          	<label class="checkbox"><input <?php echo (in_array('hr', $modules)) ? 'checked="checked"' : '' ;?> name="module[]" type="checkbox" class="validate[optional] checkbox" id="module_update_hr" value="hr" /> HR</label>
            <label class="checkbox"><input <?php echo (in_array('payroll', $modules)) ? 'checked="checked"' : '' ;?> name="module[]" type="checkbox" class="validate[optional] checkbox" id="module_update_payroll" value="payroll"/> Payroll</label>
          </td>
          </tr>
        <!--<tr>
