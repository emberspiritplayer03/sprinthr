...
<thead>
  <tr>
    ...
    <th valign="top">Basic Amount</th>        
    <th valign="top">Absent Amount</th>                 
    <th valign="top">13thmonth</th>        
  </tr>
</thead>
    <?php foreach( $yearly_bonus_data as $key => $yb ){ ?>
        <?php foreach( $yb as $subKey => $subValue ){ ?>
          <tr>                  
            ...
            <td valign="center" align="left" style="color:#333"><?php echo $subValue['total_absent_amount']; ?></td>         
            <td valign="center" align="left" style="color:#333"><?php echo $subValue['yearly_bonus']; ?></td>         
          </tr>
        <?php } ?>
    <?php } ?>    
</table>
