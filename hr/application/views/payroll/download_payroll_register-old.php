<table border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="80">Night Diff Amount</td>
  </tr>
<?php
$i = 1;
foreach ($employees as $e) {
	...
	$regular_ot_excess_hours = $labels['regular_ot_excess_hours']['value'];
	$regular_ot_excess_amount = $labels['regular_ot_excess_amount']['value'];	
	...
	$regular_ns_ot_excess_hours = $labels['regular_ns_ot_excess_hours']['value'];
	$regular_ns_ot_excess_amount = $labels['regular_ns_ot_excess_amount']['value'];	
...
?>
  <tr>
    ...
    <td width="89"><?php echo $regular_ot_excess_hours;?></td>
    <td width="91"><?php echo $regular_ot_excess_amount;?></td>    
    <td width="80"><?php echo $regular_ns_ot_hours;?></td>
    <td width="80"><?php echo $regular_ns_ot_amount;?></td>
    <td width="80"><?php echo $regular_ns_ot_excess_hours;?></td>
    <td width="80"><?php echo $regular_ns_ot_excess_amount;?></td>    
    ...
    <td width="80"><?php echo $total_nightshift_amount;?></td>
  </tr>
  <?php
	//$i++;
}
