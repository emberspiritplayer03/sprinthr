...
<?php foreach( $employee as $e  ){ ?>  
  ...
  if($add_bonus_to_earnings){
    $net_pay -= $payslip_section_deduction['bonus_/_service_award_witholding_tax']['value'];
    ...
    //   echo "false";
    // }
    // echo mb_convert_case($lastname, MB_CASE_TITLE, "UTF-8");
    // echo "<pre>";
    // var_dump($payslip_section_deduction['bonus_/_service_award_witholding_tax']);
    // echo "</pre>";
    //13th month
  ...
  $total_other_earnings = $payslip_section_other_earnings['ot_allowance']['value'] + $meal_transpo_earnings + $other_earnings + $rice_earnings + $total_ctpa_sea + $bonus_from_earnings +  $other_bonuses;
  ...
  <?php 
    ...
    $sub_total['total_union_dues_agency_fee'] += $payslip_section_deduction['union_dues']['value'] + $payslip_section_deduction['agency_fee']['value'];
