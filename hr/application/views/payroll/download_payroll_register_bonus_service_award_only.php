...
<table border="0">
    ...
    <tr><td>&nbsp;Bonus & Service Award Only</td></tr>
</table>
...
//array_multisort($grouped_data, SORT_ASC, SORT_STRING);
...
<?php foreach( $employee as $e  ){ ?>  
   ...
   * Note: 
   * Bypass code above
   * Just need to view only 13th month pay and service award
  */

  $net_pay = 0;
  if($bonus_service_award_only) {
  ...
  <?php 
    ...
    if($bonus_service_award_only) {
      ...
      $sub_total['total_witholding'] += $bonus_service_award_witholding_tax;
      ...
      $sub_total['total_ctpa_sea']       += 0;
      $sub_total['total_other_bonuses']  += $thirteenth_month_bonus_leavecon;
      $sub_total['total_other_earnings'] += $service_award;
      ...
      $sub_total['total_sss_loan'] += $payslip_section_deduction['sss_loan']['value'];
      $sub_total['total_pagibig_loan'] += $payslip_section_deduction['pagibig_loan']['value'];
  ...
  ?>
  <?php if($bonus_service_award_only) { ?>
          <tr>
  ...
  <?php } else { ?>
          <tr>
            ...
            <td style="font-size:11pt;mso-number-format:'\@';text-align:right;border:1px solid;" align="right"><?php echo number_format($payslip_section_deduction['sss_loan']['value'],2, '.' , ',' ); ?></td>
            <td style="font-size:11pt;mso-number-format:'\@';text-align:right;border:1px solid;" align="right"><?php echo number_format($payslip_section_deduction['pagibig_loan']['value'],2, '.' , ',' ); ?></td>
