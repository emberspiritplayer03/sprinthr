...
<input type="hidden" id="h_employee_id_edit" name="h_employee_id_edit" value="<?php echo Utilities::encrypt($overtime_request->getEmployeeId()); ?>" />
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2">
          <tr>
            ...
            <td style="width:85%" align="left" valign="middle">
                <input type="text" onblur="javascript:load_show_specific_schedule_edit();" style="width:150px;" id="start_date_edit" name="start_date_edit" class="validate[required]" value="<?php echo $overtime_request->getDateStart(); ?>" readonly="readonly" /><div id="_schedule_loading_wrapper_edit" style="display:inline; margin-left:10px;"></div>
          ...
          <tr>
            ...
            <td style="width:85%" align="left" valign="middle">
                <input type="text" style="width:70px;" id="start_time_edit" name="start_time_edit" class="" onchange="" placeholder="Starts on" value="<?php echo Tools::convert12To24Hour($overtime_request->getTimeIn()); ?>" />
          ...
          <tr>
            ...
            <td style="width:85%" align="left" valign="middle"><textarea tabindex="0" id="reason" name="reason" style="height:75px; width:250px"><?php echo $overtime_request->getOvertimeComments(); ?></textarea></td>
          </tr>
          <tr>
