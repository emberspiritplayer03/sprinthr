...
include $path;?>
<div class="additional_info_container"><h2>Period: <?php echo date('M j', strtotime($start_date));?> - <?php echo date('M j, Y', strtotime($end_date));?></h2></div>
  ...
  <tr>
	...
	?>
		<tr>
            ...
            <td>
                ...
                <a title="Edit Attendance" href="javascript:void(0)" onclick="javascript:editAttendance('<?php echo $date;?>', '<?php echo $encrypted_employee_id;?>', '<?php echo $start_date;?>', '<?php echo $end_date;?>')" class="link_option edit">Edit</a>
            </td>
            <td valign="top">
                ...
                <?php endif;?>
                <?php if ($is_present):?>
                	<a title="Edit Schedule and Actual Time" href="javascript:void(0)" onclick="javascript:editTimeInOut('<?php echo $date;?>', '<?php echo $encrypted_employee_id;?>', '<?php echo $start_date;?>', '<?php echo $end_date;?>')" class="link_option edit">Edit</a>
                <?php endif;?>
            </td>
            <td valign="top">
                ...
                <?php endif;?>            
                <?php if ($is_present):?>
                	<a title="Edit Overtime" href="javascript:void(0)" onclick="javascript:editOvertimeInOut('<?php echo $date;?>', '<?php echo $encrypted_employee_id;?>', '<?php echo $start_date;?>', '<?php echo $end_date;?>')" class="link_option edit">Edit</a>
                <?php endif;?>
                <?php if (($t->getOverTimeIn() != '00:00:00' && $t->getOverTimeIn() != '') && ($t->getOverTimeOut() != '00:00:00' && $t->getOverTimeOut() != '')):?> 
                	<a title="Delete Overtime" href="javascript:void(0)" onclick="javascript:deleteOvertimeByEmployeeAndDate('<?php echo $encrypted_employee_id;?>', '<?php echo $date;?>', '<?php echo $start_date;?>', '<?php echo $end_date;?>');" class="link_option edit">Delete</a>
                <?php endif;?>        
            </td>
            <td valign="top">                        
            <?php if ($is_present):?>
    ...
    <?php else:?>
		<tr>
            ...
            <td>&nbsp;</td>
            <td>-
            <a title="Edit Attendance" href="javascript:void(0)" onclick="javascript:editAttendance('<?php echo $date;?>', '<?php echo $encrypted_employee_id;?>', '<?php echo $start_date;?>', '<?php echo $end_date;?>')" class="link_option edit">Edit</a></td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
