...
<?php 
	...
	$ckeditor3->basePath	= MAIN_FOLDER. 'application/libraries/ckeditor/';
	...
	$config2['width'] = '470px';
	CKFinder::SetupCKEditor( $ckeditor3, MAIN_FOLDER.'application/libraries/ckeditor/ckfinder/');
	...
	$finder = new CKFinder() ;
	$finder->BasePath = MAIN_FOLDER.'application/libraries/ckeditor/ckfinder/' ;	// The path for the installation of CKFinder (default = "/ckfinder/").
