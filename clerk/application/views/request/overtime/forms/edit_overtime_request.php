        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2">
          <tr>
            ...
            <td style="width:85%" align="left" valign="middle">
                <input type="text" style="width:150px;" id="start_date_edit" name="start_date_edit" class="validate[required]" placeholder="From" value="<?php echo $overtime_request->getDateStart(); ?>" readonly="readonly" />
