<script>
	...
	$(function() {
		$("#request_change_schedule_form").validationEngine({scroll:false});
		$('#request_change_schedule_form').ajaxForm({
			success:function(o) {
				if(o.is_saved==1) {
					dialogOkBox('Successfully Added',{});
					cancel_request_change_schedule_form();
...
<form id="request_change_schedule_form" name="request_change_schedule_form" autocomplete="off" method="POST" action="<?php echo url('request/insert_employee_request_change_schedule'); ?>">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="2">
          <tr>
            ...
            <td style="width:85%" align="left" valign="middle">
                ...
                <input type="text" style="width:150px;" id="end_date" name="end_date" class="validate[optional]" placeholder="To" />
            </td>
          </tr>
          <tr>
    ...
    <div id="form_default" class="form_action_section">
        <table width="100%">
            <tr>
                ...
                <td><input value="Save" class="curve blue_button" type="submit">&nbsp;<a href="javascript:void(0);" onclick="javascript:cancel_request_change_schedule_form();">Cancel</a></td>
            </tr>
        </table>
    </div>
</div><!-- #form_main -->
