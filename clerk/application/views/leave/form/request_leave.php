           ...
           <!-- <tr>
            ...
            <tr>
              ...
              <td>
                ...
                <input style="margin:0 5px 0 0;" value="1" type="checkbox" name="start_halfday" id="start_halfday" onclick="javascript:wrapperComputeDaysWithHalfDay('start_halfday','end_halfday','number_of_days');" />Apply Halfday                </label>
              </td>
            </tr>
            <tr>        
