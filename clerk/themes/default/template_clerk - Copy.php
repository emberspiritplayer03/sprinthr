...
<div id="content" class="sidebar_left">
	<div class="mtcntnr">
        ...
        <?php if($leave){ ?>
        	<a id="request_leave_button" class="add_button" href="javascript:void(0);" onclick="javascript:show_request_leave_form();"><strong>+</strong><b>Request Leave</b></a><a id="leave_back" href="javascript:void(0);" onclick="javascript:back_to_leave_list();" class="gray_button title_back_button"><i></i>Back</a>
        	<a class="add_button" id="import_leave_button_wrapper" href="#" onClick="javascript:importLeave();" ><i class="icon-arrow-left"></i> Import Leave</b></a>
