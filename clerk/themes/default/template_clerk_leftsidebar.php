       ...
       <?php if($module == 'leave') { ?>
        ...
        <?php } else if($module == 'overtime') { ?>
        	 <?php if($recent){ ?>
                ...
                <a id="import_ot" class="add_button" href="javascript:void(0)" onclick="javascript:importOvertimePending('<?php echo $eid; ?>');"><i class="icon-arrow-left"></i> <b>Import OT</b></a>
            <?php } ?>
        <?php } ?>
        </h1><div class="mtshad"></div>
    </div>
    <div class="holder_sidecontent clearfix">    	
		<?php include('includes/submenu_clerk.php');?>
