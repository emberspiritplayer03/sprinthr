...
<div id="wrapper">
    ...
    <div id="wrap">
        <div id="container">
            <div id="submenu">
                <ul class="ulmenu">
                    <li><a href="<?php echo url('source/reports?sidebar=pdf_writer');?>">PDF Writer <img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                    <li ><a href="<?php echo url('source/reports?sidebar=excel');?>"> Excel<img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                     <li ><a href="<?php echo url('source/reports?sidebar=doc');?>"> Doc<img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>                    
              </ul>
            </div>
            <div id="content">
