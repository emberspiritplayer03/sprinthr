...
<div id="wrapper">
    ...
    <div id="wrap">
        <div id="container">
            <div id="submenu">
                <ul class="ulmenu">
                    <li><a href="<?php echo url('source/plugins?sidebar=autocomplete'); ?>">Autocomplete <img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                    <li ><a href="<?php echo url('source/plugins?sidebar=textboxlist'); ?>">Textbox List<img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                    <li><a href="<?php echo url('source/plugins?sidebar=chart'); ?>">Chart <img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a>
	                     <ul class="ulsubmenu">
                           <li class="<?php echo $usage; ?>"><a href="<?php echo url('source/plugins?sidebar=chart&sub_sidebar=7'); ?>">Usage</a></li>
                    <li class="<?php echo $one; ?>"><a href="<?php echo url('source/plugins?sidebar=chart&sub_sidebar=1'); ?>">Single Series Charts </a></li>
                    <li class="<?php echo $two; ?>"><a href="<?php echo url('source/plugins?sidebar=chart&sub_sidebar=2'); ?>">Multi-Series Charts </a></li>
                    <li class="<?php echo $three; ?>"><a href="<?php echo url('source/plugins?sidebar=chart&sub_sidebar=3'); ?>">Stacked Charts</a></li>
                    <li class="<?php echo $four; ?>"><a href="<?php echo url('source/plugins?sidebar=chart&sub_sidebar=4'); ?>">Combination Charts</a></li>
                    <li class="<?php echo $five; ?>"><a href="<?php echo url('source/plugins?sidebar=chart&sub_sidebar=5'); ?>">XY Plot Charts </a></li>
                    <li class="<?php echo $six; ?>"><a href="<?php echo url('source/plugins?sidebar=chart&sub_sidebar=6'); ?>">Scroll Charts</a></li>
                        </ul>
                    
                    </li>
                    <li><a href="<?php echo url('source/plugins?sidebar=datatable'); ?>">Datatable <img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                </ul>
            </div>
            <div id="content">
