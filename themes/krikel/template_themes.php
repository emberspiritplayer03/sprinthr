...
<div id="wrapper">
    ...
    <div id="wrap">
        <div id="container">
            <div id="submenu">
                <ul class="ulmenu">
                    <li><a href="<?php echo url('source/themes?sidebar=themes'); ?>">Themes <img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                    <li ><a href="<?php echo url('source/themes?sidebar=text_curve'); ?>"> Curve<img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                    <li ><a href="<?php echo url('source/themes?sidebar=periodic_table'); ?>">Periodic Table<img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                    <li ><a href="<?php echo url('source/themes?sidebar=periodic_table_form'); ?>">Periodic Table Form<img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                    <li ><a href="<?php echo url('source/themes?sidebar=forms'); ?>">Forms<img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
              </ul>
            </div>
            <div id="content">
