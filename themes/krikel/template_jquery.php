        ...
        <div id="container">
            <div id="submenu">
                <ul class="ulmenu">
                    ...
                    <li><a href="<?php echo url('source/jquery?sidebar=form_submit'); ?>">Form Submit<img class="subdropicon" src="<?php echo BASE_FOLDER; ?>themes/<?php echo THEME; ?>/themes-images/submenu_down_icon.png" /></a></li>
                </ul>
            </div>
            <div id="content">
