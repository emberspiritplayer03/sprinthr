                ...
                <div class="usrprflfooter">
                	...
                	<?php foreach($mod as $key =>$value) { ?> 			
                             <?php if($value=='audit' && MOD_AUDIT_TRAIL == true) { ?>
                           	<a class="button_link blue_button view_profile" href="<?php echo BASE_FOLDER.'index.php/audit_login'; ?>">Dashboard</a>
                            <?php } ?>
                  	<?php } ?>
                	<a class="button_link gray_button logout" href="<?php echo BASE_FOLDER.'index.php/audit_login/logout'; ?>">Logout</a>
                    <div class="clear"></div>
                </div>
            </div>
        </div>
