...
<form id="photo_upload" name="photo_form" method="post" action="<?php echo url('recruitment/_upload_photo'); ?>" enctype="multipart/form-data">
<div id="form_default" align="center">
    <img src="<?php echo $filename;  ?>?<?php echo $filemtime; ?>" width="140" border="1" align="middle"  /><br><br>
    <input type="hidden" name="applicant_id" value="<?php echo $applicant->getId(); ?>">
