<h2 class="field_title"><?php echo $title_work_experience; ?><a class="add_button" id="work_experience_add_button_wrapper" href="javascript:loadWorkExperienceAddForm();"><strong>+</strong><b>Add Work Experience</b></a></h2>
...
<table width="858" id="hor-minimalist-b"  border="0">
	  ...
	  $ctr = 0;
	   foreach($work_experience as $key=>$e) { ?>
        <tr>
          <td><a href="javascript:void(0);" onclick="javascript:loadWorkExperienceEditForm('<?php echo $e->id; ?>');"><?php echo $e->company; ?></a></td>
