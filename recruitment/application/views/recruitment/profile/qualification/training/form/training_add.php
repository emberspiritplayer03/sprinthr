...
<form id="training_add_form" name="form1" method="post" action="<?php echo url('recruitment/_update_training'); ?>">
...
<div id="form_default">
  <table>
  	 ...
  	 <tr>
  	   ...
  	   <td><input class="text-input" type="text" name="from_date" id="from_date" value="<?php echo $details->from; ?>" /></td>
    </tr>
  	 <tr>
  	   <td class="field_label">To:</td>
  	   <td><input class="text-input" type="text" name="to_date" id="to_date" value="<?php echo  ucfirst($details->to); ?>" /></td>
    </tr>
  	 <tr>
