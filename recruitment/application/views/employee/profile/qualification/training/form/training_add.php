...
<input type="hidden" name="employee_id" value="<?php echo $employee_id; ?>" />
  ...
  <table class="table_form" width="476" border="0" cellpadding="3" cellspacing="3">
  	 ...
  	 <tr>
  	   ...
  	   <td valign="top"><input type="text" name="from_date" id="training_from" value="<?php echo $details->from; ?>" /></td>
    </tr>
  	 <tr>
  	   <td align="right" valign="top">To:</td>
  	   <td valign="top"><input type="text" name="to_date" id="training_to" value="<?php echo  ucfirst($details->to); ?>" /></td>
    </tr>
  	 <tr>
