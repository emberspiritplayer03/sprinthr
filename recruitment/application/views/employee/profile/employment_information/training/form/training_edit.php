...
<div id="form_default">
  <table>
    ...
    <tr>
      ...
      <td><input class="text-input" type="text" name="from_date" id="training_from" value="<?php echo $details->from_date; ?>" /></td>
    </tr>
    <tr>
      <td class="field_label">To:</td>
      <td>
      <input class="text-input" type="text" name="to_date" id="training_to" value="<?php echo  ucfirst($details->to_date); ?>" /></td>
    </tr>
    <tr>
