...
<div id="form_default">
  <table>
  	 <tr>
  	   <td class="field_label">Subdivision:</td>
    ...
    <tr>
      ...
      <td><input type="text" class="text-input"  name="subdivision_end_date" id="subdivision_end_date" value="<?php echo $details->end_date; ?>" /></td>
    </tr>
  </table>
</div><!-- #form_default -->
