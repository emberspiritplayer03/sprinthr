<?php if($job_history) { ?><h2 class="field_title"><?php echo $title_job_history; ?><a class="add_button" id="job_history_add_button_wrapper" href="javascript:loadJobHistoryAddForm();"><strong>+</strong><b>Add Job History</b></a></h2>
...
<table width="858" id="hor-minimalist-b"  border="0">
	  ...
	  $ctr = 0;
	   foreach($job_history as $key=>$e) { ?>
        <tr>
          <td><a href="javascript:void(0);" onclick="javascript:loadJobHistoryEditForm('<?php echo $e->id; ?>');"><?php echo $e->name; ?></a></td>
