...
<div class="form_action_section" id="form_default">
    <table>
    	<tr>
          ...
          <td valign="top">
          	<a class="delete_link red float-right" href="javascript:void(0);" onclick="javascript:loadDependentDeleteDialog('<?php echo $details->id; ?>')"><span class="delete"></span>Delete Dependent</a>
          	<input class="blue_button" type="submit" name="button" id="button" value="Update" />
