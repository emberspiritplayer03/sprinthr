    ...
    <div id="form_default">      
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="left" valign="top" class="field_label">&nbsp;</td>
          <td align="left" valign="top"><label>
            <input class="validate[minCheckbox[1]] checkbox" type="checkbox" name="mod[group]" value="payroll" id="module_update_payroll" onclick="javascript:updateModuleEdit('Payroll');" />
            Payroll</label></td>
          </tr>
        <tr>
          <td align="left" valign="top" class="field_label">&nbsp;</td>
