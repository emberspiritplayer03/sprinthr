    	...
    	<div id="header">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><a href="<?php echo url("applicant"); ?>">Job Vacancy</a></li>                    
                    <li><a href="<?php echo urlMain("about_us"); ?>">About Us</a></li>
                    <li><a href="<?php echo urlMain("contact_us"); ?>">Contact</a></li>
                    <?php if($hdr_email_address){ ?>
                    	<div class="profile_info"><?php include('profile_info.php'); ?></div>
					<?php } ?>
                </ul>
            </div>             
        	<div class="clear"></div>
