    ...
    <div id="content">
        <div class="mtcntnr">
            <h1 class="module_title">
                <i class="mticon_img icon_schedule"></i><?php echo $page_title;?><?php echo $page_subtitle;?><a class="add_button tooltip" title="Create New Schedule" href="javascript:void(0)" onclick="javascript:createWeeklySchedule()"><strong>+</strong><b>Create Schedule</b></a>
            </h1>
