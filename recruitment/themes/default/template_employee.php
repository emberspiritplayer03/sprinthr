...
<div id="main" class="fullwidth">
    <div id="content">
        <div class="mtcntnr">
            <h1 class="module_title"><i class="mticon_img icon_employee"></i><?php echo $page_title;?><?php echo $page_subtitle;?><a class="add_button" id="add_employee_button_wrapper" href="#" onClick="javascript:load_add_employee();" ><strong>+</strong><b>Add Employee</b></a></h1><div class="mtshad"></div>
        </div>
