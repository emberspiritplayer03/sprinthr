...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" /><a id="otable_filter_all" title="Clear Search" style="float:right;margin:0 2px; display:none;" class="ui-icon ui-icon-closethick" href="javascript:void(0);"></a>';
