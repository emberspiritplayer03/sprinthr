...
lang.augmentObject(DT, {
     ...
     */
    CLASS_RESIZERLINER : "yui-dt-resizerliner yui-state-default",
...
_destroyContainerEl : function(elContainer) {
    ...
    if ( elements.length ) {
	  ...
	  // removeListener( elements, 'change' );
    }
...
lang.augmentObject(SDT, {
     ...
     * @default "yui-dt-hd"
     */
    CLASS_HEADER : "yui-dt-hd ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix",
