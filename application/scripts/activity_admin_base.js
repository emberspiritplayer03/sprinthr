function _deleteActivity(eid, events) {
	...
	$dialog.dialog({
		...
		buttons: {
			'Yes' : function(){
				...
				$.post(base_url+'activity/_delete_activity',{eid:eid},
					function(o){													
					if(o.is_success==1) {	
...
function _editActivity(eid, events) {
	var dialog_id = '#' + DIALOG_CONTENT_HANDLER;
	...
	$.post(base_url + 'activity/ajax_edit_activity', {eid:eid}, function(data) {
