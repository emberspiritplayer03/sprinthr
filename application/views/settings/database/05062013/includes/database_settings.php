...
function disAbleSprintTables() {
	if(document.getElementById("truncate_recommended").checked == true || document.getElementById("truncate_all").checked == true){
...
<div class="formWrapper">		
    ...
    <div class="alert alert-block alert-error">
    	...
    	<select id="sprint_tables" name="sprint_tables" class="validate[required] text">
