...
<div id="form_main" class="inner_form popup_form">
    ...
    <div class="import_links">
    	<small><a target="_blank" href="<?php echo url('startup/html_import_changed_schedule');?>" class="btn btn-link btn-mini"><i class="icon-question-sign icon-fade"></i> Need Help?</a></small>
    </div>
