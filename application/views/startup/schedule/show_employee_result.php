...
<form method="get" action="<?php //echo $action;?>">
    ...
    <button id="employee_search_submit" class="blue_button" type="submit">Search Employee</button>
    </div>
</form>
...
<script>
	...
	{
		$('#search_employee_schedule_result').html("");	
	}
</script>

<br/>
<a style="position:relative; top:-25px; right:3px;" class="btn btn-mini float-right" href="javascript:void(0);" onclick="javascript:close_search_result();" title="Close"><i class="icon-remove"></i> Close</a>
