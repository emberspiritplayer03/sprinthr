<div id="form_main" class="inner_form popup_form wider">
	<form name="addGracePeriod" id="addGracePeriod" method="post" action="<?php echo url('startup/save_grace_period'); ?>">
      <div id="form_default">
    <table width="100%"> 
         <tr>
        ...
        <tr>
            ...
            <td><input type="text" value="" name="number_minute_default" class="validate[required]  text" id="number_minute_default" /></td>
        </tr>
    </table>
    </div><!-- #form_default -->
