...
<div id="form_main" class="inner_form popup_form wider">
    ...
    <table width="100%"> 
        ...
        <tr>
            ...
            <td><input type="text" value="" name="dep_branch_name" class="validate[required] text" id="dep_branch_name" /><br />
            <small><em>(HR Department, Developer Team)</em></small></td>
        </tr>
        <tr>
          <td class="field_label">Decription:</td>
          <td><input class=" text" type="text" name="dep_description" id="dep_description" /></td>
        </tr>
    </table>
    </div><!-- #form_default -->
