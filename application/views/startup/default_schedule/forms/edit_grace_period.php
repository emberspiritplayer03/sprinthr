<div id="form_main" class="inner_form popup_form wider">
	<form name="editGracePeriod" id="editGracePeriod" method="post" action="<?php echo url('startup/save_grace_period'); ?>">
    ...
    <table width="100%"> 
        ...
        <tr>
            ...
            <td><input type="text" value="<?php echo $p->getNumberMinuteDefault(); ?>" name="number_minute_default" class="validate[required]  text" id="number_minute_default" /></td>
        </tr>
    </table>
    </div><!-- #form_default -->
