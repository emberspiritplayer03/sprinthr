...
<div id="form_main" class="inner_form popup_form">
	<form name="addSubdivision" id="addSubdivision" method="post" action="<?php echo url('startup/save_company_branch'); ?>">
    ...
    <table width="100%"> 
        ...
        <tr>
            ...
            <td >
                <select name="location_id" id="location_id" style="width:211px;">
