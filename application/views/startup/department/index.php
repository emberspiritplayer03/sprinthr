...
<div align="left">
	<a id="request_leave_button" class="add_button" href="javascript:addBranch(<?php echo $company_structure_id; ?>);"><strong>+</strong><b>Add New Branch</b></a>
</div>
<br />
<div>
      ...
      <tr>
        <td valign="middle">
            <div class="i_container">
            	<ul class="dt_icons">                	
                	<li>
                    	<a title="Edit" id="tipsy" class="btn btn-mini" href="javascript:editBranch('<?php echo Utilities::encrypt($b->getId()); ?>');">
                        	<i class="icon-pencil"></i>
                        </a>
                    </li>  
                    <li>
                    	<a title="Add Department" id="tipsy" class="btn btn-mini" href="javascript:addNewDepartment('<?php echo Utilities::encrypt($b->getId()); ?>',1);">
                        	<i class="icon-plus"></i>
                        </a>
                    </li>                                                                           
                </ul>
        ...
        <td valign="center" align="left" style="color:#333">        	
           ...
           <?php if($count_departments > 0){ ?>
               <a id="btn_dept" title="Click to manage departments" class="btn btn-primary btn-mini btn_dept" href="javascript:void(0);" onclick="javascript:load_branch_departments('<?php echo Utilities::encrypt($b->getId()); ?>');">
