		...
		success:function(o) {
			if(o==0){
				 dialogOkBox('Please Fill Up the Form Completely',{})
				  ...
				  dialogOkBox('Username is already taken',{})
			}else {
				employee_id = o;
...
<div id="formcontainer" class="formcontainer_inner">
<div class="mtshad"></div>
<form id="employee_form"  action="<?php echo url('startup/_insert_new_employee'); ?>" method="post"  name="employee_form" > 
    ...
    <div id="form_default">      
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <select class="validate[required] select_option" name="position_id" id="position_id" onchange="checkForAddPosition();">
        ...
        <tr>
          <td align="left" valign="top" class="field_label"><i class="icon-tag icon-fade"></i> Tags:</td>
          <td align="left" valign="top">
          	<!--<label id="tag-tipsy">
    ...
    <div id="form_default">      
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="left" valign="top"><input name="employee_code" type="text" class="validate[required]  text" id="employee_code" value="" /></td>
            </tr>
          <tr>
            <td align="left" valign="top" class="field_label">*Firstname:</td>
            <td align="left" valign="top"><input type="text" value="" name="firstname" class="validate[required]  text" id="firstname" /></td>
            </tr>    
          <tr>
            <td align="left" valign="top" class="field_label">*Lastname:</td>
            <td align="left" valign="top"><input type="text" value="" name="lastname" class="validate[required]  text" id="lastname" /></td>
            </tr>
          <tr>
            <td align="left" valign="top" class="field_label">*Hired Date:</td>
            <td align="left" valign="top"><input type="text" value="" name="hired_date" class="validate[required]  text" id="hired_date_add_employee" /></td>
          </tr>
        </table>
    </div>
    ...
    <div id="form_default">      
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="left" valign="top">
          <div id="status_dropdown_wrapper">
            <input class="validate[required,minSize[5]]" type="password" name="password" id="password" />
          </div>
          </td>
        </tr>
        <tr>
          <td align="left" valign="top" class="field_label">Confirm Password:</td>
          <td align="left" valign="top"><input class="validate[required,equals[password]]" type="password" name="confirm_password" id="confirm_password" /></td>
        </tr>
        <!--<tr>
        ...
        <tr>
          ...
          <td align="left" valign="top">
          <label class="checkbox"><input type="checkbox" name="mod[group]" value="hr" id="module_hr" onclick="javascript:updateModule('HR');">HR</label>
		  ...
		  <label class="checkbox"><input type="checkbox" name="module_payroll" value="payroll" id="module_payroll" onclick="javascript:updateModule('Payroll');" />Payroll</label>
