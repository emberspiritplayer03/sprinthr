 <script>
$("#import_employee_form_startup1").validationEngine({scroll:false});

$('#import_employee_form_startup1').ajaxForm({
			success:function(o) {				
...
<form method="post" id="import_employee_form_startup1" name="import_employee_form_startup1" action="<?php echo $import_action;?>" enctype="multipart/form-data">	
