...
<div id="form_main" class="inner_form popup_form">
    ...
    <input type="hidden" value="<?php echo $branch->id; ?>" name="d_dep_branch_id" id="d_dep_branch_id" />
    <div id="form_default">
    <table width="100%"> 
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" value="" name="d_dep_branch_name" class="validate[required] text-input text" id="d_dep_branch_name" /><br />
            <small><em>(HR Department, Developer Team)</em></small></td>
        </tr>
        <tr>
          <td class="field_label">Decription:</td>
          <td><input class="text-input text" type="text" name="d_dep_description" id="d_dep_description" /></td>
        </tr>
    </table>
    </div><!-- #form_default -->
