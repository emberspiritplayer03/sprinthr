<table width="100%" border="0">
  <tr>
	...
	echo renderChartHTML(BASE_FOLDER . "chart/StackedColumn2D.swf", "", $strXML, "Monthly",500,300, false);
	?>
    </td>
    <td width="40%">&nbsp;</td>
  </tr>
  <tr>
	...
	echo renderChartHTML(BASE_FOLDER . "chart/StackedColumn3D.swf", "", $strXML, "Monthly",500,300, false);
	?>
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
	...
	echo renderChartHTML(BASE_FOLDER . "chart/StackedArea2D.swf", "", $strXML, "Monthly",500,300, false);
...
echo renderChartHTML(BASE_FOLDER . "chart/StackedBar2D.swf", "", $strXML, "Monthly",500,300, false);
	?>
    </td>
    <td>&nbsp;</td>
  </tr>
...
<?php 
    echo renderChartHTML(BASE_FOLDER . "chart/StackedBar3D.swf", BASE_FOLDER. "/chart/data/StBar3D.xml", '', "Monthly",500,300, false);
	?>
    </strong></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <?php 
    echo renderChartHTML(BASE_FOLDER . "chart/MSStackedColumn2D.swf", BASE_FOLDER. "/chart/data/StMSCol2D.xml", '', "Monthly",500,300, false);
	?>
    </td>
    <td>&nbsp;</td>
  </tr>
