...
class Source_Controller extends Controller
{
	...
	{
		Loader::appLibrary('class_pdf_writer');		
	...
	function chart() {
		...
		Loader::appLibrary('FusionCharts');
	...
	function inline_validation() 
	{
		...
		Loader::appStyle('assets/inlinevalidation/template.css');
	...
	{
		//print_r($_POST);
		Loader::appLibrary('class_jquery_file_upload');	
	}
