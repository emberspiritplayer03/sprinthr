...
/*
	Usage:
		...
		$e->save();		
*/
class G_Attendance_Log_V2 extends Attendance_Log_V2 {
	const TYPE_IN = 'in';
	const TYPE_OUT = 'out';
	...
	public function save() {
		return G_Attendance_Log_Manager_V2::save($this);
	}
	...
	*/
	...
	public function deleteLog() {
		...
		if( $this->id > 0 ){
			$total_deleted = G_Fp_Attendance_Logs_Manager_V2::delete($this);
			$return['is_success'] = true;
