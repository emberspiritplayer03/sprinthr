<?php
class G_Settings_Weekly_Deduction_Breakdown {
	...
	public function getOptionsIsTaxable() {
		$is_taxable_options = array(G_Settings_Weekly_Deduction_Breakdown::YES, G_Settings_Weekly_Deduction_Breakdown::NO);
	...
	public function getAllContributions( $ids = array() ) {
		...
		$data   = G_Settings_Weekly_Deduction_Breakdown_Helper::sqlDeductionDataByIds($ids);
	...
	public function getActiveContributionsBreakDown() {
		...
		$data = G_Settings_Weekly_Deduction_Breakdown_Helper::sqlGetAllActiveDeductionBreakDown();
	...
	public function save() {
		return G_Settings_Weekly_Deduction_Breakdown_Manager::save($this);
	}
	
	public function delete() {
		return G_Settings_Weekly_Deduction_Breakdown_Manager::delete($this);
	}
}
