...
class G_Philhealth_Manager {	
	...
	public static function update(G_Philhealth $e) {
		if ( $e ) {	
			$sql = "
				UPDATE ". PHILHEALTH . " 
				SET
					...
					salary_base				= " . Model::safeSql($e->getSalaryBase()) .",
					salary_bracket			= " . Model::safeSql($e->getSalaryBracket()) .",
					from_salary				= " . Model::safeSql($e->getFromSalary()) .",
					to_salary				= " . Model::safeSql($e->getToSalary()) .",
					monthly_contribution = " . Model::safeSql($e->getMonthlyContribution()) ."
	...
	public static function importPhilHealthTable( $file = '' ) {		
		$total_failed_import  = 0;
		$total_success_import = 0;
		$sql 		          = "INSERT INTO " . PHILHEALTH . "(salary_bracket,from_salary,to_salary,salary_base,monthly_contribution,employee_share,company_share)VALUES";
		...
		$failed_logs        = array();	
		$valid_col_index    = array("A","B","C","D","E","F","G");
		$required_col_index = array("A","B","C","D","E","F","G");
		$row_counter        = 0;		
