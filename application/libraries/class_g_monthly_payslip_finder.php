<?php
class G_Monthly_Payslip_Finder {
	...
	public static function findAllByYearWithOptions($year, $options, $fields) {
		...
		//		AND p.id IN (35588,35635,35606,35563,35609,35612,35517,35472, 35637,35619,35607,35502,35533,35658)
		// SELECT p.* FROM g_employee_monthly_payslip p LEFT JOIN g_employee e ON p.employee_id = e.id WHERE DATE_FORMAT(p.period_end,'%Y')=2019 ORDER BY p.employee_id ASC
	...
	public static function findAllByCutOffWithOptions($cutoff_date, $options, $fields) {
		...
		// $sql = "SELECT  FROM g_employee_monthly_payslip p LEFT JOIN g_employee e ON p.employee_id = e.id WHERE p.period_start ='2018-12-26' AND e.id = 3 ORDER BY p.employee_id ASC 3";
