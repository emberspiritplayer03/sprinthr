...
// manual but easy
	...
	//1. CREATE an element that will handle the records
...
class Paginator{
	...
	function display_jump_menu_ajax($id)
	{
		...
		return "<span class=\"paginate\">Page:</span><select class=\"paginate\" onchange=javascript:gotoPage(1,\"'.$this->form_id.'\");>$option</select>\n";
	}
