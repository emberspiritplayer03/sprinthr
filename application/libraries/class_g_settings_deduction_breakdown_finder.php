<?php
class G_Settings_Deduction_Breakdown_Finder {
	
	public static function findById($id) {
		$sql = "
			SELECT *
			FROM ". G_SETTINGS_DEDUCTION_BREAKDOWN ." e
	...
	public static function findByIdAndIsActive($id) {
		$sql = "
			SELECT *
			FROM ". G_SETTINGS_DEDUCTION_BREAKDOWN ." e
			WHERE e.id = ". Model::safeSql($id) ." AND e.is_active =" . Model::safeSql(G_Settings_Deduction_Breakdown::YES) . "	
			LIMIT 1		
		";
		return self::getRecord($sql);
	}
