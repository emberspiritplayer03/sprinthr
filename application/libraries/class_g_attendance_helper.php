...
class G_Attendance_Helper
{
    ...
    {
        $sql = "
            SELECT date_attendance FROM " . G_EMPLOYEE_ATTENDANCE . "
    ...
    */
    ...
    public static function recordTimecard(IEmployee $e, $date, $time_in, $time_out, $date_in, $date_out, $overtime_in, $overtime_out, $grace_period = 0, $breaks = array())
    {
        ...
        $t->setOvertimeOut($overtime_out);
        $a->setTimesheet($t);
        $employee_attendance_id = $a->recordToEmployee($e);
    ...
    */
    ...
    public static function sqlCountAbsentDaysByDateRange($from = '', $to = '')
    {
        $sql = "
            ...
            FROM " . G_EMPLOYEE_ATTENDANCE . " ea LEFT JOIN " . EMPLOYEE . " e ON ea.employee_id = e.id 
