...
/*
	Usage:
		...
		$e->save();		
*/
class G_Employee_Attendance_V2 extends Employee_Attendance_V2 {
	const TYPE_IN = 'in';
	const TYPE_OUT = 'out';
	...
	public function save() {
		return G_Employee_Attendance_Log_Manager_V2::save($this);
	}
	...
	*/
    ...
    public function changeTime($time_in, $time_out, $project_site, $has_error, $error_message) {
        $this->setTimeIn($time_in);
		$this->setTimeOut($time_out);
		$this->setProjectSiteId($project_site);
		$this->setHasError($has_error);
	...
	public function deleteLog() {
		...
		if( $this->id > 0 ){
			$total_deleted = G_Employee_Attendance_Manager_V2::delete($this);
			$return['is_success'] = true;
