...
//$baseUrl = 'http://localhost/test/ckfinder_nulled/files/';
$baseUrl ='/'. $_SESSION['editor']['ckfinder_baseUrl'];
...
ATTENTION: The trailing slash is required.
*/
//$baseDir = 'D:/xampp/htdocs/test/ckfinder_nulled/files/';
//$baseDir = $_SERVER['DOCUMENT_ROOT'].BASE_FOLDER;
$baseDir = $_SERVER['DOCUMENT_ROOT'].'/'.$_SESSION['editor']['ckfinder_baseDir'];
//$baseDir = resolveUrl($baseUrl);
/*
 * ### Advanced Settings
 */
