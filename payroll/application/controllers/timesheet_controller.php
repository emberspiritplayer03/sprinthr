<?php
class Timesheet_Controller extends Controller
{
	...
	function index() {		
		...
		$this->view->render('timesheet/index.php', $this->var);		
	}
	...
	function ajax_show_holiday_list() {
		...
		$branches = G_Company_Branch_Finder::findAll();	
		$this->var['total_branches'] = count($branches);
