...
<table width="342" border="0" cellpadding="0" cellspacing="0" style="border:1px solid black; font-size: xx-small;">
  ...
  <tr>
    ...
    <td width="69">SSS:</td>
    <td width="67" align="left"><span class="font-size"><?php echo ($sss > 0) ? number_format($sss,2) : '-';?></span></td>
  ...
  <tr>
    ...
    <td align="left"><span class="font-size"><?php echo number_format($gross_pay,2);?></span></td>
    <td><strong>Deductions:</strong></td>
    <td align="left"><span class="font-size"><?php echo number_format($total_deductions, 2);?></span></td>
    <td align="left">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="6">&nbsp;</td>
