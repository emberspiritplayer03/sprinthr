<table width="100%" border="0">
  ...
  <tr>
   ...
   echo renderChartHTML(MAIN_FOLDER . "chart/Column3D.swf", "", $strXML, "Monthly",500, 300, false);

?></td>
    <td width="40%"><img src="<?php echo MAIN_FOLDER;  ?>themes/krikel/images/BtnViewXML.gif" /></td>
  </tr>
  <tr>
   ...
   //Create the chart - Column 3D Chart with data from strXML variable using dataXML method
   echo renderChartHTML(MAIN_FOLDER . "chart/Column2D.swf", MAIN_FOLDER."chart/data/Column2D.xml", "", "Monthly",500, 300, false);
...
?></td>
  ...
  <tr>
   ...
   //Create the chart - Column 3D Chart with data from strXML variable using dataXML method
   echo renderChartHTML(MAIN_FOLDER . "chart/Pie3D.swf", "", $strXML, "Monthly",500, 300, false);
...
?>
  ...
  <tr>
   ...
   //Create the chart - Column 3D Chart with data from strXML variable using dataXML method
   echo renderChartHTML(MAIN_FOLDER . "chart/Pie2D.swf", "", $strXML, "Monthly",500, 300, false);
...
?>
  ...
  <tr>
   ...
   //Create the chart - Column 3D Chart with data from strXML variable using dataXML method
   echo renderChartHTML(MAIN_FOLDER . "chart/line.swf", "", $strXML, "Monthly",600, 300, false);
?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
   ...
   //Create the chart - Column 3D Chart with data from strXML variable using dataXML method
   echo renderChartHTML(MAIN_FOLDER . "chart/bar2d.swf", "", $strXML, "Monthly",600, 300, false);
?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
   ...
   //Create the chart - Column 3D Chart with data from strXML variable using dataXML method
   echo renderChartHTML(MAIN_FOLDER . "chart/area2d.swf", "", $strXML, "Monthly",600, 300, false);
?>
  ...
  <tr>
    ...
    <?php 
	 ...
	 $strXML .= "<chart palette='2'>
		  ...
		  echo renderChartHTML(MAIN_FOLDER . "chart/Doughnut2D.swf", "", $strXML, "Monthly",600, 300, false);
	?>
