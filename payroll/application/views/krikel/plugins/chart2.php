<table width="100%" border="0" cellpadding="3" cellspacing="2">
  <tr>
   ...
   echo renderChartHTML(MAIN_FOLDER . "chart/MSColumn2D.swf", "", $strXML, "Monthly",500, 300, false);
...
?></td>
  ...
  <tr>
	...
	<set value='92633.68'/></dataset>
	 ...
	 echo renderChartHTML(MAIN_FOLDER . "chart/MSColumn3D.swf", "", $strXML, "Monthly",500, 300, false);
	?>
  ...
  <tr>
	...
	<application>
	 ...
	 echo renderChartHTML(MAIN_FOLDER . "chart/MSLine.swf", "", $strXML, "Monthly",500, 300, false);
	?>
  ...
  <tr>
	...
	echo renderChartHTML(MAIN_FOLDER . "chart/MSArea.swf", "", $strXML, "Monthly",500, 300, false);
  ...
  <tr>
	...
	echo renderChartHTML(MAIN_FOLDER . "chart/MSBar2D.swf", "", $strXML, "Monthly",500, 300, false);
	?>
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
   ...
   echo renderChartHTML(MAIN_FOLDER . "chart/MSBar3D.swf", "", $strXML, "Monthly",500, 500, false);
   ?> 
    </td>
    <td>&nbsp;</td>
  </tr>
