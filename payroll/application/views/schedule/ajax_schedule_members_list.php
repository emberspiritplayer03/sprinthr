    ...
    <table width="100%" class="formtable">
      <thead>
        ...
        <?php foreach ($groups as $g):?>
          ...
          <td style="border-bottom:1px solid #cccccc"><a class="" href="javascript:void(0)" onclick="javascript:removeScheduleMember(<?php echo $g->getId();?>, '<?php echo $schedule_id;?>', 'group')" style="float:right;" title="Remove"><i class="icon-remove"><span class="tooltip" title="Remove"></span></i></a><?php echo $g->getName();?></td>
          </tr>
        <?php endforeach;?>
      	<?php endif;?>
    ...
    <table width="100%" class="formtable">
      <thead>
        ...
        <tr id="<?php echo $e->getId();?>-<?php echo $schedule_id;?>-employee">
          <td style="border-bottom:1px solid #cccccc"><a class="" href="javascript:void(0)" onclick="javascript:removeScheduleMember(<?php echo $e->getId();?>, '<?php echo $schedule_id;?>', 'employee')" style="float:right;" title="Remove"><i class="icon-remove"><span class="tooltip" title="Remove"></span></i></a><?php echo $e->getLastname();?>, <?php echo $e->getFirstname();?></td>
          </tr>
        <?php endforeach;?>
        <?php endif;?>
    </table>
