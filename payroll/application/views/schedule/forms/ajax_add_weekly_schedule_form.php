...
<div id="form_main" class="inner_form popup_form wider">
    ...
    <table class="no_border" width="100%">
    	<tr>
        	<td width="24%" class="field_label">*Name:</td>
        ...
        <tr>
          ...
          <td><input class="validate[required] text-input" type="text" name="effectivity_date" id="effectivity_date" value="" /></td>
        </tr>        
        ...
        <tr>
          ...
          <td>
            ...
            <span <?php echo $clear_link_visible;?> id="clear_link_<?php echo $number;?>" class="clear_link"><a class="btn btn-mini" href="javascript:clearTime(<?php echo $number;?>)"><i class="icon-remove-circle"></i> Clear</a></span><br />
...
$("#add_schedule_form #effectivity_date").datepicker({dateFormat:'yy-mm-dd',changeMonth:true,changeYear:true,showOtherMonths:true});
</script>