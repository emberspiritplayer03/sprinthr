<h2 class="field_title"><?php echo $title_license; ?><a class="add_button" id="license_add_button_wrapper" href="javascript:loadLicenseAddForm();"><strong>+</strong><b>Add License</b></a></h2>
