...
<div id="form_default">
  <table>
    ...
    <tr>
      ...
      <td><input type="text" class="validate[required] text-input" name="from_date" id="from_date" value="<?php echo $details->from_date; ?>" /></td>
    </tr>
    <tr>
      <td class="field_label">To:</td>
      <td><input type="text" class="validate[required] text-input" name="to_date" id="to_date" value="<?php echo $details->to_date; ?>" /></td>
    </tr>
    <tr>
...
<div class="form_action_section" id="form_default">
    <table>
    	<tr>
            ...
            <td><input class="blue_button" type="submit" name="button" id="button" value="Update" />&nbsp;<a href="javascript:void(0);" onclick="javascript:loadWorkExperienceTable();">Cancel</a></td>
    	</tr>
    </table>
