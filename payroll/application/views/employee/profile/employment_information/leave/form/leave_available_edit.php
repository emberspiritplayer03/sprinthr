...
<div id="form_default">
  <table>
  	 ...
  	 <tr>
  	   ...
  	   <td><input class="text-input" type="text" name="no_of_days_alloted" id="no_of_days_alloted" value="<?php echo $details->no_of_days_alloted; ?>" /></td>
    </tr>
  	 <tr>
  	   <td class="field_label">Number of Days Available:</td>
  	   <td><input class="text-input" type="text" name="no_of_days_available" id="no_of_days_available" value="<?php echo  ucfirst($details->no_of_days_available); ?>" /></td>
    </tr>
  </table>
</div><!-- #form_default -->
