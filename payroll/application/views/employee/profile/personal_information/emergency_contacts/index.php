<h2 class="field_title"><?php echo $title_emergency_contact; ?><a class="add_button" id="emergency_contact_add_button_wrapper" href="javascript:loadEmergencyContactAddForm();"><strong>+</strong><b>Add Emergency Contacts</b></a></h2>
...
<table width="858" id="hor-minimalist-b" summary="Employee Pay Sheet" border="0">
	  ...
	  $ctr = 0;
	   foreach($contacts as $key=>$e) { ?>
        <tr>
          <td><a href="javascript:void(0);" onclick="javascript:loadEmergencyContactEditForm('<?php echo $e->id; ?>');"><?php echo $e->person; ?></a></td>
