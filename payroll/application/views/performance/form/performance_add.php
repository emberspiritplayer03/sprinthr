...
$("#period_from").datepicker({dateFormat: 'yy-mm-dd',changeMonth: true,changeYear: true});
$("#period_to").datepicker({dateFormat: 'yy-mm-dd',changeMonth: true,changeYear: true});
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <div id="status_dropdown_wrapper">
            <input type="text" class="text-input" name="period_from" id="period_from" />
          </div>
          </td>
        </tr>
        <tr>
          <td align="left" valign="top" class="field_label">Period To:</td>
          <td align="left" valign="top"><input type="text" class="text-input" name="period_to" id="period_to" /></td>
        </tr>
        <tr>
