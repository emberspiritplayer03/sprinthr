...
<tr>
    ...
    <input type="text" value="<?php echo $job_spec_info->getName(); ?>" name="name" class="validate[required] text-input text" id="name" />
    </td>
</tr>
<tr>
    <td width="30%" valign="top" class="formControl">Description</td>
    <td width="70%" valign="top" class="formLabel">
    <textarea style="width:249px; height:60px;" name="description" class="validate[required] text-input text" id="description"><?php echo $job_spec_info->getDescription(); ?></textarea>    
    </td>
</tr>
...
<tr>
    ...
    <td width="70%" valign="top" class="formLabel">
    <textarea style="width:249px; height:60px;" name="duties" class="validate[required] text-input text" id="duties"><?php echo $job_spec_info->getDuties(); ?></textarea>      
    </td>
</tr>
