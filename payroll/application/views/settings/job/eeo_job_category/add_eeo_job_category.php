...
$(document).ready(function() {
	$("#taskForm").validationEngine({
		ajaxSubmit: true,
		scroll: false,
		ajaxSubmitFile: base_url + 'settings/add_eeo_job_category',
		ajaxSubmitMessage: "",
		success : function() {load_job_eeo_job_list_dt();disablePopUp();var $dialog = $('#action_form');$dialog.dialog("destroy");},
		unbindEngine:true,
		failure : function() {}	
	});
});
...
<tr>
    ...
    <input type="text" value="" name="category_name" class="validate[required] text-input text" id="category_name" />
    </td>
</tr>
