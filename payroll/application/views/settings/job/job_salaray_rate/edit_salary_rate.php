...
$(document).ready(function() {
	$("#job_rate_form").validationEngine({
		ajaxSubmit: true,
		scroll: false,
		ajaxSubmitFile: base_url + 'settings/update_job_salary_rate',
		ajaxSubmitMessage: "",
...
<tr>
    ...
    <input type="text" value="<?php echo $job_salary_rate->getJobLevel(); ?>" name="job_level" class="validate[required] text-input text" id="job_level"  />
    </td>
</tr>
<tr>
    <td width="30%" valign="top" class="formControl">Minimum Salary</td>
    <td width="70%" valign="top" class="formLabel">
    <input type="text" value="<?php echo $job_salary_rate->getMinimumSalary(); ?>" name="minimum_salary" class="validate[required] text-input text" id="minimum_salary" />
    </td>
</tr>
...
<tr>
    ...
    <td width="70%" valign="top" class="formLabel">
    <input type="text" value="<?php echo $job_salary_rate->getMaximumSalary(); ?>" name="maximum_salary" class="validate[required] text-input text" id="maximum_salary" />
    </td>
</tr>
...
<tr>
    ...
    <td width="70%" valign="top" class="formLabel">
    <input type="text" value="<?php echo $job_salary_rate->getStepSalary(); ?>" name="step_salary" class="validate[required] text-input text" id="step_salary" />
    </td>
</tr>
