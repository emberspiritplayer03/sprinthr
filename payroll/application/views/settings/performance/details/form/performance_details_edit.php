    ...
    <div id="form_default" class="form_action_section">
        <table>
            <tr>
                ...
                <td><a href="javascript:void(0);" class="delete_link red float-right"><span class="delete"></span>Delete Language</a><input class="blue_button" name="button" type="submit" id="button" value="Update" />&nbsp;<a href="javascript:void(0);" onclick="javascript:loadPerformanceDetailsTable();">Cancel</a></td>
            </tr>
        </table>
    </div>
</form>
