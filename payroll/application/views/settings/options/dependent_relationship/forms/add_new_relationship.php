...
function callFailFunction(){alert("Error on SQL")}
	$(document).ready(function() {		
		 $("#addRelationship").validationEngine({						
			ajaxSubmit: true,
			scroll: false,
			ajaxSubmitFile: base_url + 'settings/add_relationship',	
			ajaxSubmitMessage: "",		
			success : function() {load_dependent_relationship_dt();disablePopUp();var $dialog = $('#action_form');$dialog.dialog("destroy");disablePopUp();},
			unbindEngine:true,
			failure : function() {}
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="0"> 
        <tr>
            ...
            <td width="70%" valign="top" class="formLabel">
                <input type="text" value="" name="relationship" class="validate[required] text-input text" id="relationship" />    
            </td>
        </tr>    
    </table>
    <br />
