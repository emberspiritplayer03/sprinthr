...
function callFailFunction(){alert("Error on SQL")}
	$(document).ready(function() {		
		 $("#addPayPeriod").validationEngine({						
			ajaxSubmit: true,
			scroll: false,
			ajaxSubmitFile: base_url + 'settings/add_pay_period',	
			ajaxSubmitMessage: "",		
...
<div class="formWrapper">
	<form name="addPayPeriod" id="addPayPeriod" method="post" action="">   
    <table width="100%" border="0" cellpadding="3" cellspacing="0"> 
        <tr>
            <td width="30%" valign="top" class="formControl">Pay Period Code</td>
            <td width="70%" valign="top" class="formLabel">
                <input type="text" value="" name="pay_period_code" class="validate[required] text-input text" id="pay_period_code" />    
            </td>
        </tr>  
        <tr>
            <td width="30%" valign="top" class="formControl">Pay Period Name</td>
            <td width="70%" valign="top" class="formLabel">
                <input type="text" value="" name="pay_period_name" class="validate[required] text-input text" id="pay_period_name" />    
            </td>
        </tr>
        <tr>
          <td valign="top" class="formControl">Cut Off</td>
          <td valign="top" class="formLabel"><input type="text" value="" name="cut_off" class="validate[required] text-input text" id="cut_off" /></td>
        </tr>
        <tr>
          <td valign="top" class="formControl">Is Default</td>
          <td valign="top" class="formLabel"><input type="text" value="" name="is_default" class="validate[required] text-input text" id="is_default" /></td>
        </tr>    
    </table>
    <br />
    <div align="right">
