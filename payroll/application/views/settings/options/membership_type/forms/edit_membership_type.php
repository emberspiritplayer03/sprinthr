...
function callFailFunction(){alert("Error on SQL")}
	$(document).ready(function() {		
		 $("#addMembership").validationEngine({						
			ajaxSubmit: true,
			scroll: false,
			ajaxSubmitFile: base_url + 'settings/update_membership_type',	
			ajaxSubmitMessage: "",		
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="0"> 
        <tr>
            ...
            <td width="70%" valign="top" class="formLabel">
                <input type="text" value="<?php echo $m->getType(); ?>" name="type" class="validate[required] text-input text" id="type" />    
            </td>
        </tr>          
    </table>
    <br />
