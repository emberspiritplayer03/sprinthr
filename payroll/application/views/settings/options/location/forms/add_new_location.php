...
function callFailFunction(){alert("Error on SQL")}
	$(document).ready(function() {		
		 $("#addLocation").validationEngine({						
			ajaxSubmit: true,
			scroll: false,
			ajaxSubmitFile: base_url + 'settings/add_location',	
			ajaxSubmitMessage: "",		
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="0"> 
        <tr>
            ...
            <td width="70%" valign="top" class="formLabel">
                <input type="text" value="" name="location" onchange="javascript:generateCode();" class="validate[required] text-input text" id="location" />    
            </td>
        </tr>  
        <tr>
