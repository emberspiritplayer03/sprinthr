...
function callFailFunction(){alert("Error on SQL")}
	$(document).ready(function() {		
		 $("#addRelationship").validationEngine({						
			ajaxSubmit: true,
			scroll: false,
			ajaxSubmitFile: base_url + 'settings/add_employment_status',	
			ajaxSubmitMessage: "",		
...
<div class="formWrapper">
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top" class="formLabel"><input type="text" value="" name="status" class="validate[required] text-input text" id="status" /></td>
        </tr>
        <tr>
          <td valign="top" class="formControl">&nbsp;</td>
