<table border="1" cellpadding="2" cellspacing="1" style="font-size:9pt; width:836pt; line-height:12pt;">
    ...
    <?php
		...
		$pagibig_number = '="' . $e->getPagibigNumber() . '"';
	?>
    <tr>
    	<td align="left" valign="top" style="border-top:none; border-bottom:none; <?php echo $bg; ?>">
        	<strong><?php echo $pagibig_number;?></strong></span>
        </td>
