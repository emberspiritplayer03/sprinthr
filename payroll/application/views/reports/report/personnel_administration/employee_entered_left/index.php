...
<form name="form1" method="post" action="<?php echo url('reports/applicant_list'); ?>">
    ...
    <div id="form_default">
        <table width="100%">
            ...
            <tr>
                <td class="field_label">  <input type="radio" name="radio_group1" value="Education" >Entered </input></td>
            ...
            <tr>
                <td class="field_label"><input type="radio" name="radio_group1" value="Education" >Left</input></td>
