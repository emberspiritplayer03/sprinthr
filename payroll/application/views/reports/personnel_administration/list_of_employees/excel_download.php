...
$pe->getActiveSheet()->setTitle('Employee List');

$pe->write(0, 0, 'Employee List', $header);
...
$pe->write(3, 2, 'Lastname', $field_name);
$pe->write(3, 3, 'Firstname', $field_name);
$pe->write(3, 4, 'Middlename', $field_name);
$pe->write(3, 5, 'Extension Name', $field_name);
$pe->write(3, 6, 'Position', $field_name);
$pe->write(3, 7, 'Hired Date', $field_name);
$start_row = 4;
...
foreach ($data as $key => $val) {
	...
	$pe->write($start_row, 2, $val['lastname'], $text);
	$pe->write($start_row, 3, $val['firstname'], $text);
	$pe->write($start_row, 4, $val['middlename'], $text);
	$pe->write($start_row, 5, $val['extension_name'], $text);
	$pe->write($start_row, 6, $val['position'], $text);
	$pe->write($start_row, 7, $val['hired_date'], $text);
