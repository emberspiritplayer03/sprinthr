...
foreach($emp as $key => $value){	
	...
	$worksheet2->write($start_row,9,$emp[$key]['gross_pay'],$number);// col 9 gross pay
	...
	$worksheet2->write($start_row,15,$emp[$key]['total_late_undertime'],$emphasize_format);// col 15 total late/undertime
	...
	$worksheet2->write($start_row,22,$emp[$key]['pf'],$number);// col22 placement fee
	$worksheet2->write($start_row,23,$emp[$key]['deductions'],$number);// col23 total deductions
	$worksheet2->write($start_row,24,$emp[$key]['net_pay'],$number);// col24 net pay
