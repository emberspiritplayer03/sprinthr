...
<form id="applicant_list_form" name="applicant_list_form" method="post" action="<?php echo url('reports/download_applicant_list'); ?>">	
    ...
    <div id="form_default">
      <table width="100%">
          ...
          <td><select name="search_field" class="select_option" id="search_field" onChange="javascript:checkIfAll();">
        ...
        <tr>
          ...
          <td><label for="position_applied"></label>
            <select name="position_applied" class="select_option" id="position_applied" >
