    ...
    <div id="form_main">
        ...
        <table width="100%">
          <tr>
            ...
            <td><input type="text" class="text-input" name="holiday_name" id="_holiday_name" onchange="holidayNameChanged()" /> 
              <small>(e.g. Rizal Day)</small></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
                <label><input onchange="checkAllBranches('#add_holiday_form')" name="branches[]" type="checkbox" value="all" id="_checkbox-all" />All</label><br />
                <?php foreach ($branches as $b):?>        	
                <label><input onchange="checkBranch('#add_holiday_form')" class="_branch_checkbox" name="branches[]" type="checkbox" value="<?php echo $b->getId();?>" id="_checkbox-<?php echo $b->getId();?>" /><?php echo $b->getName();?></label><br />
                <?php endforeach;?>
            </td>
          </tr>
          </table>
