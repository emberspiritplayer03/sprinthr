<script>
$("#skill_edit_form").validationEngine({scroll:false});
$('#skill_edit_form').ajaxForm({
	success:function(o) {
		if(o==1) {
...
<form id="skills_edit_form" name="form1" method="post" action="<?php echo url('recruitment/_update_skill'); ?>" >
...
<div id="form_default">
  <table>
      ...
      <td><input type="text" class="validate[required] text-input" name="skill" id="skill" value="<?php echo $details->skill; ?>" /></td>
    </tr>
    <tr>
      <td class="field_label">Years of Experience:</td>
      <td><input class="text-input" type="text" name="years_experience" id="years_experience" value="<?php echo $details->years_experience; ?>" /></td>
    </tr>
    <tr>
