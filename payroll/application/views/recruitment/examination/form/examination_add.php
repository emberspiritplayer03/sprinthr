      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="left" valign="top">
            ...
            <select class="validate[required] select_option" name="title" id="title" onchange="javascript:loadExaminationDetails();">
        ...
        <tr>
          ...
          <div id="status_dropdown_wrapper">
            <input type="text" class="validate[required,custom[integer] text-input" name="passing_percentage" id="passing_percentage" />
          </div>
          </td>
        </tr>
        <tr>
