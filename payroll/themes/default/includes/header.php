...
<div id="wrapper">
	<div id="header_wrapper">
        <div id="header_container" <?php if($is_trial_period == true){echo "class='trial_period'";}?>>
        	<?php
				if($is_trial_period == true){
					include('trial_counter.php');
				}
			?>
            <div id="header" class="clearfix">
                <div class="logo_container">
                	<h2 style="background-image:url(<?php echo MAIN_FOLDER; ?>themes/<?php echo MAIN_THEME; ?>/themes-images/<?php echo $sprint_logo; ?>);">Payroll</h2><!--<img src="<?php //echo MAIN_FOLDER; ?>themes/<?php //echo MAIN_THEME; ?>/themes-images/<?php //echo $sprint_logo; ?>" border="0" alt="Sprint" />-->
                </div>
