...
<div id="profile_tab">
    <div class="pt_notification">
        <a href="#"><i></i>New <span class="noti_count">13+</span></a>
    </div>
    <ul>
            ...
            <div id="usrprfl_cntnr">
                <div class="usrprfl_content">
                    ...
                    <div class="usrprflfooter">
                        <?php if(MOD_CLERK == false && MOD_EMPLOYEE == false && MOD_HR == false){ ?>
                        ...
                        <?php foreach($mod as $key =>$value) { ?>	
                               <?php if($value=='clerk' && MOD_CLERK == true) { ?>
                                    <a class="button_link blue_button view_profile" href="<?php echo MAIN_FOLDER.'clerk/index.php/dashboard'; ?>">Clerk</a>
                               <?php } ?>
                               ...
                               <?php if($value=='hr' && MOD_HR == true && $hr_mod['main'] == true) { ?>
